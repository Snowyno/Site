...
} elseif ($_instance->childHasBeenRendered('nZYIgCY')) {
    $componentId = $_instance->getRenderedChildComponentId('nZYIgCY');
    $componentTag = $_instance->getRenderedChildComponentTagName('nZYIgCY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nZYIgCY');
} else {
    $response = \Livewire\Livewire::mount('main.partials.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('nZYIgCY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
function mudaDark(){
  ...
  <?php /**PATH /home/u991810173/domains/p2win.com.br/public_html/resources/views/livewire/main/seller/layout/app.blade.php ENDPATH**/ ?>