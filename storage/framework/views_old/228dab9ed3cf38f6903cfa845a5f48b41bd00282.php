<div class="w-full">
    ...
    <div class="px-4 md:px-3 py-4 md:py-5 bg-white border !border-b-0 dark:bg-gray-700 rounded-tl-lg rounded-tr-lg">
        <div class="sm:flex items-center justify-between">
            <p class="text-sm font-bold leading-wide text-gray-800">
                <?php echo e(__('messages.t_bwl')); ?>

            </p>
            <div>
                <a href="<?php echo e(admin_url('blackwordslist/create')); ?>" class="focus:ring-2 focus:ring-offset-2 focus:ring-primary-600 inline-flex sm:ml-3 mt-4 sm:mt-0 items-start justify-start px-6 py-3 bg-primary-600 hover:bg-primary-700 focus:outline-none rounded-sm">
    ...
    <div class="bg-white dark:bg-zinc-800 overflow-y-auto border !border-t-0 !border-b-0 dark:border-zinc-600">
        <table class="w-full whitespace-nowrap old-tables">
            ...
            <tbody class="w-full">
                ...
                <?php $__currentLoopData = $blackwordslists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blackwordslist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="focus:outline-none h-20 text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40" wire:key="blackwordslist-<?php echo e($blackwordslist->id); ?>">

                        
                        <td class="ltr:pl-4 rtl:pr-4">
                            <p class="font-medium text-xs"><?php echo e($blackwordslist->palvra); ?></p>
                        </td>
                        ...
                        <td class="text-center">
                            <div class="relative inline-block text-left">
                                ...
                                <div id="table-options-dropdown-<?php echo e($blackwordslist->id); ?>" class="hidden z-40 origin-top-right absolute right-0 mt-2 w-44 rounded-md shadow-lg bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 dark:divide-zinc-700 focus:outline-none" role="menu"  aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                    <div class="py-1" role="none">

                                        
                                        <a href="<?php echo e(admin_url('blackwordslist/edit/' . $blackwordslist->uid)); ?>" class="text-gray-800 dark:text-gray-300 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">
                                            ...
                                            <span class="text-xs font-medium"><?php echo e(__('messages.t_edit_bwl')); ?></span>
                                        </a>

              

                                        
                                        <button x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_delete_this')); ?>') ? $wire.delete('<?php echo e($blackwordslist->id); ?>') : ''" wire:loading.attr="disabled" wire:target="delete('<?php echo e($blackwordslist->id); ?>')" type="button" class="text-gray-800 dark:text-gray-300 dark:hover:text-gray-400 group flex items-center px-4 py-2 text-sm" role="menuitem" tabindex="-1" >

                                            
                                            <div wire:loading wire:target="delete('<?php echo e($blackwordslist->id); ?>')">
                                            ...
                                            <div wire:loading.remove wire:target="delete('<?php echo e($blackwordslist->id); ?>')">
    ...
    <?php if($blackwordslists->hasPages()): ?>
        <div class="bg-gray-100 px-4 py-5 sm:px-6 rounded-bl-lg rounded-br-lg flex justify-center border-t-0 border-r border-l border-b">
            <?php echo $blackwordslists->links('pagination::tailwind'); ?>

        </div>
    <?php endif; ?>

</div>
<?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/admin/blackwordslist/blackwordslist.blade.php ENDPATH**/ ?>