...
<div>
    <div class="flex items-center space-x-2">
        ...
        <?php if(settings('footer')->social_facebook): ?>
            <a href="<?php echo e(settings('footer')->social_facebook); ?>" target="_blank" data-tooltip-target="tooltip-follow-us-facebook" class="w-10 h-10 flex items-center justify-center bg-gray-100  rounded-md group rtl:ml-2">
        ...
        <?php if(settings('footer')->social_twitter): ?>
            <a href="<?php echo e(settings('footer')->social_twitter); ?>" target="_blank" data-tooltip-target="tooltip-follow-us-twitter" class="w-10 h-10 flex items-center justify-center bg-gray-100  rounded-md group">
        ...
        <?php if(settings('footer')->social_instagram): ?>
            <a href="<?php echo e(settings('footer')->social_instagram); ?>" target="_blank" data-tooltip-target="tooltip-follow-us-instagram" class="w-10 h-10 flex items-center justify-center bg-gray-100  rounded-md group">
        ...
        <?php if(settings('footer')->social_pinterest): ?>
            <a href="<?php echo e(settings('footer')->social_pinterest); ?>" target="_blank" data-tooltip-target="tooltip-follow-us-pinterest" class="w-10 h-10 flex items-center justify-center bg-gray-100  rounded-md group">
        ...
        <?php if(settings('footer')->social_linkedin): ?>
            <a href="<?php echo e(settings('footer')->social_linkedin); ?>" target="_blank" data-tooltip-target="tooltip-follow-us-linkedin" class="w-10 h-10 flex items-center justify-center bg-gray-100  rounded-md group">
        ...
        <?php if(settings('footer')->social_github): ?>
            <a href="<?php echo e(settings('footer')->social_github); ?>" target="_blank" data-tooltip-target="tooltip-follow-us-github" class="w-10 h-10 flex items-center justify-center bg-gray-100  rounded-md group">
        ...
        <?php if(settings('footer')->social_youtube): ?>
            <a href="<?php echo e(settings('footer')->social_youtube); ?>" target="_blank" data-tooltip-target="tooltip-follow-us-youtube" class="w-10 h-10 flex items-center justify-center bg-gray-100  rounded-md group">
      ...
      <div class="col-6 col-md-2 mt-2">
        <h3 class="titulo"><?php echo e(__('messages.t_Sell')); ?></h3>
        <ul class="list-unstyled">
          <li class="gf-color-white gf-fontsize font-weight-lighter mb-2">
            <a href="https://p2win.com.br/documents/becomeAseller"><?php echo e(__('messages.t_Become_a_Seller')); ?></a>
          </li>
          <li class="gf-color-white gf-fontsize font-weight-lighter mb-2">
            <a href="https://p2win.com.br/documents/sellGameItems"><?php echo e(__('messages.t_Sell_Game_Items')); ?></a>
          </li>
          <li class="gf-color-white gf-fontsize font-weight-lighter mb-2">
            <a href="https://p2win.com.br/documents/sellVideoGames"><?php echo e(__('messages.t_Sell_Video_Games')); ?></a>
          </li>
          <li class="gf-color-white gf-fontsize font-weight-lighter mb-2">
            <a href="https://p2win.com.br/documents/sellGiftCards"><?php echo e(__('messages.t_Sell_Gift_Cards')); ?></a>
          </li>
        </ul>
      </div>
      <div class="col-6 col-md-2  mt-2">
        <h3 class="titulo"><?php echo e(__('messages.t_Buy')); ?></h3>
        <ul class="list-unstyled">
          <li class="gf-color-white gf-fontsize font-weight-lighter mb-2">
            <a href="https://p2win.com.br/documents/howToBuy"><?php echo e(__('messages.t_How_to_Buy')); ?></a>
          </li>
          <li class="gf-color-white gf-fontsize font-weight-lighter mb-2">
            <a href="https://p2win.com.br/documents/buyGameItems"><?php echo e(__('messages.t_Buy_Game_Items')); ?></a>
          </li>
          <li class="gf-color-white gf-fontsize font-weight-lighter mb-2">
            <a href="https://p2win.com.br/documents/buyVideoGames"><?php echo e(__('messages.t_Buy_Video_Games')); ?></a>
          </li>
          <li class="gf-color-white gf-fontsize font-weight-lighter mb-2">
            <a href="https://p2win.com.br/documents/buyGiftCards"><?php echo e(__('messages.t_Buy_Gift_Cards')); ?></a>
          </li>
        </ul>
      </div>
      <div class="col-6 col-md-2 mt-2">
        <h3  class="titulo"><?php echo e(__('messages.t_FAQ')); ?></h3>
        <ul class="list-unstyled">
          <li class="gf-color-white gf-fontsize font-weight-lighter mb-2">
            <a href="https://p2win.com.br/documents/howDoesP2WinWork"><?php echo e(__('messages.t_How_Does_P2_Win_Work')); ?></a>
          </li>
          <li class="gf-color-white gf-fontsize font-weight-lighter mb-2">
            <a href="https://p2win.com.br/documents/whatIstheP2WinGuarantee"><?php echo e(__('messages.t_What_is_the_P2_Win_Guarantee')); ?></a>
          </li>
          <li class="gf-color-white gf-fontsize font-weight-lighter mb-2">
            <a href="https://p2win.com.br/documents/howDoesP2Winprotectsellers"><?php echo e(__('messages.t_How_does_P2_Win_protect_sellers')); ?></a>
          </li>
        </ul>
      </div>
      <div class="col-6 col-md-2 mt-2 ">
        <h3  class="titulo"><?php echo e(__('messages.t_Resources')); ?></h3>
        <ul class="list-unstyled">
          <li class="gf-color-white gf-fontsize font-weight-lighter mb-2">
            <a href="https://p2win.com.br/documents/returnPolicy"><?php echo e(__('messages.t_Return_Policy')); ?></a>
          </li>

          <li class="gf-color-white gf-fontsize font-weight-lighter mb-2">
            <a href="https://p2win.com.br/help/contact"><?php echo e(__('messages.t_Contact_Us')); ?></a>
          </li>
    ...
    <div class="row mt-3">
      <p class="col-12 col-md-6">
        ...
        <span class="gf-color-white mr-4">
          <a href="/documents/aboutUs"><?php echo e(__('messages.t_About_Us')); ?></a>
        </span>
        <span class="gf-color-white mr-4">
          <a href="/documents/terms"><?php echo e(__('messages.t_Terms_of_Use')); ?></a>
        </span>
        <span class="gf-color-white mr-4">
          <a href="/documents/privacyPolicy"><?php echo e(__('messages.t_Privacy_Policy')); ?></a>
        </span>
        <br>
...
<?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/main/includes/footer.blade.php ENDPATH**/ ?>