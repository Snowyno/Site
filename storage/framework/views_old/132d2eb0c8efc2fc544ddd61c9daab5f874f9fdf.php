...
} elseif ($_instance->childHasBeenRendered('zr0UW73')) {
    $componentId = $_instance->getRenderedChildComponentId('zr0UW73');
    $componentTag = $_instance->getRenderedChildComponentTagName('zr0UW73');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zr0UW73');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('zr0UW73', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('cMdCvON')) {
    $componentId = $_instance->getRenderedChildComponentId('cMdCvON');
    $componentTag = $_instance->getRenderedChildComponentTagName('cMdCvON');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cMdCvON');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('cMdCvON', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/u991810173/domains/p2win.com.br/public_html/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>