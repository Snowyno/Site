                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="row mx-1 my-1 px-1 py-1 border border-gray-200 dark:border-zinc-600 rounded-lg ">
                                    ...
                                    <!--
                                    <h1 class="text-base font-bold text-gray-900 hover:text-primary-600 mb-2 dark:text-white">Produto: <?php echo e($item->gig->title); ?></h1>
                                    <br>
                                    <dt class="font-medium text-gray-900 dark:text-gray-200">Vendido por: <?php echo e($gig->owner->username); ?></dt>
                                    <br>
                                    -->
                                    
                                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $gig, 'profile_visible' => true])->html();
    ...
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $gig, 'profile_visible' => true]);
    $html = $response->html();
...
?>
                                            ...
                                            <dl class="mt-2 divide-y divide-gray-200 border-t border-b border-gray-200 dark:divide-zinc-700 dark:border-zinc-700">
                                                ...
                                                <div class="flex justify-between py-3 text-sm font-medium">
                                                    ...
                                                    <dd class="text-gray-900 dark:text-gray-200">
                                                        ...
                                                        <?php if($item->refund && $item->refund->status === 'closed'): ?>
                                                        ...
                                                        <?php else: ?>
                                                            <?php switch($item->status):
                                                                ...
                                                                <?php case ('waiting'): ?>
                                                                    <span class="text-gray-600 text-sm font-medium"><?php echo e(__('messages.t_waiting_buyer_as_buyer')); ?></span>
                                                                <?php break; ?>
                                                            <?php endswitch; ?>
                                                        <?php endif; ?>                                                            
                                                    </dd>
                                                ...
                                                <div class="flex justify-between py-3 text-sm font-medium">
                                                    ...
                                                    <dd class="text-gray-900 dark:text-gray-200  font-extrabold"><?php echo e(__($item->quantity)); ?></dd>
                                                </div>
                                                
                                                <div class="flex justify-between py-3 text-sm font-medium">
                                                    <dt class="text-gray-500 dark:text-gray-400"><?php echo e(__('messages.t_amount')); ?></dt>
                                                    <dd class="text-gray-900 dark:text-gray-200  font-extrabold"><?php echo money($item->total_value, settings('currency')->code, true); ?></dd>
                                                </div>
                                                ...
                                                <?php if(!$item->is_finished && $item->status === 'refunded'): ?>
                                                
                                                <!--
                                                <div class="flex justify-between py-3 text-sm font-medium">
                                                    <dt class="text-gray-500 dark:text-gray-400"><?php echo e(__('messages.t_refund_date')); ?></dt>
                                                    <dd class="text-gray-900 dark:text-gray-200"><?php echo e(format_date($item->created_at, 'ago')); ?></dd>
                                                </div>
                                                -->
                                                <?php endif; ?>
                            ...
                            <div class="col-6">
                                ...
                                <div class="row mx-1 my-1 px-1 py-1 border border-gray-200 dark:border-zinc-600 rounded-lg ">
                                    <div class="col-2 py-3">
                                        <center>
                                            ...
                                            <?php else: ?>
                                                <?php if(!$item->is_finished && $item->status === 'pending'): ?>
                                                <img src="https://p2win.com.br/public/img/order/order_status_img/pending.png" />
                                                <?php endif; ?>
                                                <?php if(!$item->is_finished && $item->status === 'proceeded'): ?>
                                                <img src="https://p2win.com.br/public/img/order/order_status_img/pending.png" />
                                                <?php endif; ?>
                                                <?php if(!$item->is_finished && $item->status === 'waiting'): ?>
                                                <img src="https://p2win.com.br/public/img/order/order_status_img/pending.png" />
                                                <?php endif; ?>
                                                <?php if($item->is_finished && $item->status === 'delivered'): ?>
                                                <img src="https://p2win.com.br/public/img/order/order_status_img/delivered.png" />
                                                <?php endif; ?>
                                                <?php if(!$item->is_finished && $item->status === 'canceled'): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="col-10 px-3 py-3">
                                            ...
                                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300"><?php echo e(__('messages.t_waiting_buyer_as_buyer')); ?></p>
                                        </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="col-10 px-3 py-3">
                                            ...
                                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300"><?php echo e(__('messages.t_waiting_for_seller')); ?></p>
                                        </div>
                                        <?php endif; ?>
                                        <?php if($item->is_finished && $item->status === 'delivered'): ?>
                                    ...
                                    <div class="col-12 px-3 py-1">
                                        ...
                                        <?php if(!$item->is_finished && !$item->refund): ?>
                                            <div class="flex items-center mb-8 text-blue-500">
                                                ...
                                                <?php echo e(__('messages.t_order_item_will_mark_done_after_1_week')); ?> <?php echo date("d/m/Y \à\s h:i:s A", strtotime($item->delivered_at));  ?>
                                                </span>
                                ...
                                <div class="row mx-1 my-1 px-1 py-1 border border-gray-200 dark:border-zinc-600 rounded-lg ">
                                    ...
                                    <?php if(!$item->is_finished && $item->status === 'waiting'): ?>
                                        <?php if(!$item->refund): ?>
                                        <h2 class="text-base leading-6 font-bold text-gray-900 dark:text-gray-100"><?php echo e(__('messages.t_review_and_complete_transaction')); ?></h2>
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">
                                            <!--Deve completar esta ação em: -->
                                            <?php echo e(__('messages.t_agir_ate')); ?>
                                        ...
                                        <a href="<?php echo e(url('account/refunds/details/'.$item->refund->uid)); ?>" class="gig-card-title font-semibold text-gray-800 dark:text-gray-100 hover:text-primary-600 dark:hover:text-white mb-4 !overflow-hidden">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <?php if(!$item->is_finished && $item->status === 'delivered' OR $item->status === 'waiting' AND !$item->refund): ?>
...
<?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/main/account/orders/options/files.blade.php ENDPATH**/ ?>