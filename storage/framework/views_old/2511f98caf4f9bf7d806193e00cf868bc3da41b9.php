<div class="w-full bg-white shadow rounded-lg">
    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_subcategories_detail')); ?></h2>
            </div>
...
<?php endif; ?>
                    ...
                    <?php if($subcategorydetail->icon): ?>
                        <div class="mt-3">
                            <img src="<?php echo e(src( $subcategorydetail->icon )); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    <?php endif; ?>
                </div>
...
<?php endif; ?>
                    ...
                    <?php if($subcategorydetail->image): ?>
                        <div class="mt-3">
                            <img src="<?php echo e(src( $subcategorydetail->image )); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    <?php endif; ?>
                </div>
...
</div>    <?php /**PATH /home/u991810173/domains/p2win.com.br/public_html/resources/views/livewire/admin/subcategoriesdetail/options/EditDetail.blade.php ENDPATH**/ ?>