        ...
        <header class="border-b-2 border-gray-100 dark:border-zinc-700 py-8 rounded-t-md">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <h1 class="mt-2 text-xl font-bold leading-7 text-gray-900 dark:text-gray-100 sm:text-2xl sm:truncate"><?php echo e(__('messages.t_withdrawals')); ?></h1>
                ...
                <div class="mt-5 flex xl:mt-0 xl:ltr:ml-4 xl:rtl:mr-4">
                    ...
                    <span class="block ltr:ml-3 rtl:pr-3">
                        <a href="<?php echo e(url('account/withdrawals/settings')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-zinc-500 rounded-sm shadow-sm text-[13px] font-medium text-gray-700 dark:text-zinc-200 bg-white dark:bg-zinc-600 hover:bg-gray-50 dark:hover:bg-zinc-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-primary-600">
                            ...
                            <thead class="bg-gray-50 dark:bg-zinc-600">
                                <tr>
                                    ...
                                    <th scope="col" class="px-10 py-3 ltr:text-left rtl:text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                                        <?php echo e(__('messages.t_date')); ?>

                                    </th>

                                    
                                    <th scope="col" class="px-10 py-3 ltr:text-left rtl:text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                                            <?php echo e(__('messages.t_for')); ?>
                                    ...
                                    <th scope="col" class="px-10 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                                            <?php echo e(__('messages.t_status')); ?>
                                ...
                                <?php $__currentLoopData = $withdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="px-10 py-6 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-300">
                                            <?php echo e(format_date($w->created_at, 'F j, Y')); ?>
                                        ...
                                        <td class="px-10 py-4 whitespace-nowrap text-center text-sm font-bold">
                                            <?php switch($w->status):
                                                ...
                                                case ('pending'): ?>
                                                    <span class="text-amber-500"><?php echo e(__('messages.t_pending')); ?></span>
                                                    <?php break; ?>
                                                <?php case ('paid'): ?>
                                                    <span class="text-green-500"><?php echo e(__('messages.t_paid')); ?></span>
                                                    <?php break; ?>
                                                <?php case ('rejected'): ?>
                                                    <span class="text-red-500"><?php echo e(__('messages.t_rejected')); ?></span>
                                                    <?php break; ?>
                                                <?php default: ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u991810173/domains/p2win.com.br/public_html/resources/views/livewire/main/account/withdrawals/withdrawals.blade.php ENDPATH**/ ?>