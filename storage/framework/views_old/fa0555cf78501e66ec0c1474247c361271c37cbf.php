<div class="w-full bg-white shadow rounded-lg">
    ...
    <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
        <div class="py-10 px-12">
            ...
            <div class="mb-14">
                <h2 class="text-sm leading-6 font-bold text-gray-900"><?php echo e(__('messages.t_edit_subcategory_detail')); ?></h2>
            </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('messages.t_subcategory_detail_slug')).'','placeholder' => ''.e(__('messages.t_enter_subcategory_detail_slug')).'','model' => 'slug','icon' => 'link-variant']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginala0274761f86638d78e36787c771a294b67c238db)): ?>
<?php $component = $__componentOriginala0274761f86638d78e36787c771a294b67c238db; ?>
...
<?php endif; ?>
                    ...
                    <?php if($subcategoryd->icon): ?>
                        <div class="mt-3">
                            <img src="<?php echo e(src( $subcategoryd->icon )); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    <?php endif; ?>
                </div>
...
<?php endif; ?>
                    ...
                    <?php if($subcategoryd->image): ?>
                        <div class="mt-3">
                            <img src="<?php echo e(src( $subcategoryd->image )); ?>" class="h-32 rounded-lg intense cursor-pointer object-cover">
                        </div>
                    <?php endif; ?>
                </div>
...
</div>    <?php /**PATH /home/u991810173/domains/p2win.com.br/public_html/resources/views/livewire/admin/subcategoriesd/options/edit.blade.php ENDPATH**/ ?>