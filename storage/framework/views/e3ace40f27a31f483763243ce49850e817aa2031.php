...
<style>
    ...
    .fundoUniverso{
  background-image: url(https://gameflip.com/img/front/background_home.webp);
...
<div class="fundoUniverso">
<?php
if(Lang::locale() == 'pt'){
    include('resources/views/livewire/main/documents/includes/pt/sellVideoGames.php');
}
else{
    include('resources/views/livewire/main/documents/includes/eng/sellVideoGames.php');
}
?> 
</div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/main/documents/sellVideoGames.blade.php ENDPATH**/ ?>