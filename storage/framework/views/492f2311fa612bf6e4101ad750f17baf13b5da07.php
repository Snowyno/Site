                ...
                <div class="lg:col-span-2 xl:col-span-3">
                    <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $gigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="<?php echo $online; ?> col-span-12 lg:col-span-6 md:col-span-6 sm:col-span-6 xl:col-span-4" wire:key="gigs-list-<?php echo e($gig->uid); ?>">
                                <?php
if (! isset($_instance)) {
...
<script>
    document.addEventListener("DOMContentLoaded", function(){
        ...
        ?>
            ...
            window.$wireui.notify({title: '<?php echo app('translator')->get('messages.t_attention_needed'); ?>', description: '<?php echo app('translator')->get('messages.t_item_sold_off'); ?>',icon: 'error'});
        <?php
...
<!--<script src="<?php echo e(url('public/altasis/tempoRestante.js')); ?>"> </script>--><?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/main/search/search.blade.php ENDPATH**/ ?>