...
} elseif ($_instance->childHasBeenRendered('jwc5yiO')) {
    $componentId = $_instance->getRenderedChildComponentId('jwc5yiO');
    $componentTag = $_instance->getRenderedChildComponentTagName('jwc5yiO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jwc5yiO');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('jwc5yiO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('VdP7BcE')) {
    $componentId = $_instance->getRenderedChildComponentId('VdP7BcE');
    $componentTag = $_instance->getRenderedChildComponentTagName('VdP7BcE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VdP7BcE');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('VdP7BcE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
