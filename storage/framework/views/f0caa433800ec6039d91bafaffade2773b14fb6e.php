                ...
                <thead>
                    <?php $__empty_1 = true; $__currentLoopData = $gigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="freelancer-dashboard-gigs-<?php echo e($gig->uid); ?>">
                                                ...
                                                <ol role="list" class="flex items-center space-x-1 rtl:space-x-reverse">
                                                    ...
                                                    <li>
                                                        <div class="flex items-center">
                                                            <span class="dark:text-zinc-300">
                                                            <?php
                                                            if(isset($gig->category->slug) AND ($gig->category->slug != NULL OR $gig->category->slug != null OR $gig->category->slug != "")){
                                                           
                                                                echo $gig->category->name;
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                            <?php
                                if($gig->counter_sales == 0 AND $gig->orders_in_queue == 0){
                            ?>
...
<script>
    document.addEventListener("DOMContentLoaded", function(){
        ...
        ?>
            ...
            window.$wireui.notify({title: '<?php echo app('translator')->get('messages.t_success'); ?>', description: '<?php echo app('translator')->get('messages.t_gig_editions_saved'); ?>',icon: 'success'});
        <?php
        }
        ?>
    });
...
<?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/main/seller/gigs/gigs.blade.php ENDPATH**/ ?>