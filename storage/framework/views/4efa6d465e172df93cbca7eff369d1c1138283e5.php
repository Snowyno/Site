                                        ...
                                        <div class="md:flex md:items-center md:justify-between md:space-x-4 md:rtl:space-x-reverse xl:border-b xl:pb-6 dark:xl:border-zinc-700">
                                            ...
                                            <div class="mt-4 flex md:mt-0">
                                                <?php if($refund->status === 'rejected_by_seller' && !$refund->request_admin_intervention): ?>
                                                    <button style="border-radius: 13px; border: none;" x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_raise_dispute_refund', ['app_name' => config('app.name')])); ?>') ? $wire.raise : ''" 
                                                    wire:loading.attr="disabled" wire:target="raise" type="button" 
                                                    
                                                    class="
                                                    inline-flex items-center px-4 py-2 border border-gray-300 dark:border-zinc-600 rounded-sm shadow-sm text-xs font-bold tracking-wide text-red-700 dark:text-red-200 
                                                    bg-red-200 dark:bg-red-200 hover:bg-red-300 dark:hover:bg-red-300 focus:outline-none focus:ring-2 focus:ring-offset-2">

                                                    <!--class="inline-flex items-center px-3 py-2 border border-transparent text-xs leading-4 font-bold tracking-wide 
                                                    rounded-sm text-red-700 bg-red-200 hover:bg-red-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">-->
                                                        ...
                                                        <span class="text-sm font-bold"><?php echo e(__('messages.t_raise_a_dispute')); ?></span>
                                                    </button>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                ...
                                <section class="mt-8 xl:mt-10">
                                    <div>
                                        ...
                                        ?>
                                                                <li>
                                                                    <div class="relative pb-8">
                                                                        ...
                                                                        <div class="relative flex items-start space-x-3 rtl:space-x-reverse">
                                                                            ...
                                                                            <div class="relative">
                                                                                <img class="lazy h-10 w-10 rounded-full bg-gray-400 dark:bg-zinc-800 flex items-center justify-center ring-8 ring-white dark:ring-transparent object-cover" 
                                                                                src="https://p2win.com.br/public/storage/default/default-placeholder.jpg" 
                                                                                data-src="https://p2win.com.br/public/storage/default/default-placeholder.jpg" 
                                                                                alt="admin_logo">
                                                                            </div>
                                                                            <div class="min-w-0 flex-1">
                                                                                <div>
                                                                                    <div class="text-sm">
                                                                                        <a href="https://p2win.com.br"
                                                                                            target="_blank" class="font-medium text-gray-900 dark:text-gray-200 dark:hover:text-primary-600 hover:text-primary-600">Admin</a>
                                                                                    </div>
                                                                                    <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                                                                                        <?php echo e(format_date($msg->created_at, 'ago')); ?>
                                                ...
                                                <?php if($refund->status != 'accepted_by_seller' AND $refund->status != 'accepted_by_admin'): ?>
...
<?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/main/account/refunds/options/details.blade.php ENDPATH**/ ?>