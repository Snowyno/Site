                            ...
                            <?php $__currentLoopData = $gig->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li
                                    ...
                                    <div class="fileuploader-item-inner">
                                        <div class="type-holder"><?php echo e($img->large->file_extension); ?></div>
        ...
        <div class="col-span-12 mt-2">
            ...
            <div class="col-span-12 md:col-span-6">
                    ...
                    <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        if($category == $cat['id']){ 
                        ?>
                        <option class="dark:bg-zinc-700" onclick="selecionaCategoria(<?php echo $cat['id']; ?>);"  value="<?php echo e($cat['id']); ?>" selected><?php echo e($cat['name']); ?></option>
                        <?php
                        }
                        else{
                        ?>
                        <option class="dark:bg-zinc-700" onclick="selecionaCategoria(<?php echo $cat['id']; ?>);"  value="<?php echo e($cat['id']); ?>"><?php echo e($cat['name']); ?></option>
                        <?php
                        }
                        ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-span-12 md:col-span-6">
                    ...
                    <?php $__currentLoopData = $subcategorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <?php
                        ...
                        ?>
                           <option class="dark:bg-zinc-700" onclick="selecionaSubCategoria(<?php echo $subcat['id']; ?>);"  class="subcategoria sub_parent_<?php echo e($subcat['parent_id']); ?>" value="<?php echo e($subcat['id']); ?>" selected><?php echo e($subcat['name']); ?></option>
                        <?php
                        }
                        else{
                        ?>
                          <option class="dark:bg-zinc-700" onclick="selecionaSubCategoria(<?php echo $subcat['id']; ?>);"  class="subcategoria sub_parent_<?php echo e($subcat['parent_id']); ?>" value="<?php echo e($subcat['id']); ?>"><?php echo e($subcat['name']); ?></option>
                        <?php
                        }
                        ?>
                ...
                <div class="col-span-12 md:col-span-6">
                    ...
                    <?php $__currentLoopData = $subcategoriasd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcatd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                           <option class="dark:bg-zinc-700" onclick="selecionaSubCategoriad(<?php echo $subcatd['id']; ?>);" class="subcategoriad subd_parent_<?php echo e($subcatd['parent_id']); ?>" value="<?php echo e($subcatd['id']); ?>" selected><?php echo e($subcatd['name']); ?></option>
                        <?php
                        }
                        else{
                        ?>
                           <option class="dark:bg-zinc-700" onclick="selecionaSubCategoriad(<?php echo $subcatd['id']; ?>);" class="subcategoriad subd_parent_<?php echo e($subcatd['parent_id']); ?>" value="<?php echo e($subcatd['id']); ?>"><?php echo e($subcatd['name']); ?></option>
                        <?php
                        }
                        ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="flex justify-between mb-5" id="btn_save_ok" style="display: inline;">
    <button action="back" text="<?php echo e(__('messages.t_back')); ?>" active="bg-white dark:bg-zinc-700 dark:hover:zinc-800 shadow-sm hover:bg-gray-300 text-gray-900 dark:text-gray-300"  />
...
?> <?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/main/seller/gigs/options/steps/gallery.blade.php ENDPATH**/ ?>