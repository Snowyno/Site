            ...
            <tbody class="w-full">
                ...
                <?php $__currentLoopData = $gigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40" wire:key="reports-<?php echo e($gig->id); ?>">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ltr:pl-4 rtl:pr-4">
                                    ...
                                    <div class="flex items-center text-[11px] font-normal text-gray-400">
                                        ...
                                        <?php
                                            if(isset($gig->category->name) AND $gig->category->name != NULL){
                                        ...
                                        <?php
                                            if(isset($gig->subcategory->name) AND $gig->subcategory->name != NULL){
                                                
                                               echo $gig->subcategory->name;
                        ...
                        <td class="text-center">
                            <span class="text-xs text-gray-500 font-medium"><?php echo date('d/m/Y', strtotime($gig->updated_at)); ?> </span>
                        </td>
...
</div><?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/admin/gigs/gigs.blade.php ENDPATH**/ ?>