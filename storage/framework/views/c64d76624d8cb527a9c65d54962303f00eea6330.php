				...
				<div class="flex-shrink-0 flex h-16 bg-white dark:bg-zinc-800 border-b border-[#e9eef5] dark:border-zinc-600">
					...
					<div class="flex-1 px-4 md:px-6 flex justify-between">
						...
						<div class="ltr:ml-4 rtl:mr-4 flex items-center md:ltr:ml-6 md:rtl:mr-6">
							...
							<a href="<?php echo e(url('messages')); ?>" class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 relative mx-4 dark:text-gray-100 dark:hover:text-white">
...
} elseif ($_instance->childHasBeenRendered('cPea8IC')) {
    $componentId = $_instance->getRenderedChildComponentId('cPea8IC');
    $componentTag = $_instance->getRenderedChildComponentTagName('cPea8IC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cPea8IC');
} else {
    $response = \Livewire\Livewire::mount('main.partials.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('cPea8IC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
function mudaDark(){
  ...
  <?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/main/seller/layout/app.blade.php ENDPATH**/ ?>