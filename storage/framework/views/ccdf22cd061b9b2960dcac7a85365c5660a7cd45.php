<div wire:id="hir344M6qipfVrpSHAKf" class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-16 pb-24 space-y-8 min-h-screen">
                        ...
                        <div class="py-6 px-4 sm:p-6 lg:pb-8 h-[calc(100%-80px)]">
                            ...
                            <div class="w-full mb-6">
                                ...
                                <div>
                                    <!--
                                    Ordenar por: Status 
                                    <svg id="filtroStatusAsc" style="<?php //echo $filtroStatusAsc; ?> position: absolute; width: 13px !important; cursor: pointer;margin: -24px 0px 0px 165px;color: green;" onclick="window.location.href = '?col=id&order=asc';"  class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
                                    ...
                                    <svg id="filtroStatusDesc" style="<?php //echo $filtroStatusDesc; ?> position: absolute; width: 13px !important; cursor: pointer;margin: -24px 0px 0px 165px;color: green;"  onclick="window.location.href = '?col=id&order=desc';" class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 8">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control" id="statusFilterSelect"  name="statusFilterSelect" onchange="changeFilter();">
                                                <option value="todos" <?php echo (!isset($_GET['statusFilter'])) ? "selected" : ""; ?>> <?php echo app('translator')->get('messages.t_all'); ?> </option>
                                                <option value="dispute_opened" <?php echo (isset($_GET['statusFilter']) AND $_GET['statusFilter'] == "dispute_opened") ? "selected" : ""; ?>><?php echo app('translator')->get('messages.t_dispute_opened'); ?></option>
                                                <option value="pending" <?php echo (isset($_GET['statusFilter']) AND $_GET['statusFilter'] == "pending") ? "selected" : ""; ?>> <?php echo app('translator')->get('messages.t_pending'); ?> </option>
                                                <option value="proceeded" <?php echo (isset($_GET['statusFilter']) AND $_GET['statusFilter'] == "proceeded") ? "selected" : ""; ?>> <?php echo app('translator')->get('messages.t_proceed'); ?> </option>
                                                <option value="delivered" <?php echo (isset($_GET['statusFilter']) AND $_GET['statusFilter'] == "delivered") ? "selected" : ""; ?>> <?php echo app('translator')->get('messages.t_delivered'); ?> </option>
                                                <option value="canceled" <?php echo (isset($_GET['statusFilter']) AND $_GET['statusFilter'] == "canceled") ? "selected" : ""; ?>> <?php echo app('translator')->get('messages.t_canceled'); ?> </option>
                                                <option value="refunded" <?php echo (isset($_GET['statusFilter']) AND $_GET['statusFilter'] == "refunded") ? "selected" : ""; ?>> <?php echo app('translator')->get('messages.t_refunded'); ?></option>
                                    ...
                                    <script>
                                        function changeFilter(){
                                            ...
                                            if(status != "todos"){
                                                ...
                                                window.location.href = 'https://p2win.com.br/account/orders';
                                            }
                                    ...
                                    <div  class="">
                                        ...
                                        foreach($order->items as $item){
                                            ...
                                            if(isset($_GET['statusFilter'])){
                                                ...
                                                if( $_GET['statusFilter'] == 'dispute_opened'){
                                                    $filterRef = 'pending';
                                                    $itemStatus = 'pending';
                                                    
                                                }
                                                else{
                                                    $filterRef = $_GET['statusFilter'];
                                                    $itemStatus = $_GET['statusFilter'];
                                                }

                                                if((isset($item->refund->status) AND $item->refund->status == $filterRef) OR (isset($item->status) AND $item->status == $itemStatus))
                                                {
                                                if(isset($item->refund->status)){
                                                    if($item->refund->status == 'pending'){
                                                        $classSts = 'dispute_opened';
                                                    }
                                                    else{
                                                        $classSts = $item->refund->status;
                                                    }
                                                }
                                                else{
                                                    $classSts = $item->status;
                                                }

                                                ?>
                                                    <li class="Ewerton <?php echo $classSts; ?> p-2 sm:p-3 bg-white dark:bg-zinc-700 border border-gray-200 dark:border-zinc-600 rounded-md mb-10">
                                                        <div  class="bg-gray-50 dark:bg-zinc-600 border-b sm:rounded-t-md flex items-center p-2 sm:p-2 sm:grid sm:grid-cols-4 sm:gap-x-6 dark:border-zinc-600">
                                                        ...
                                                        <dl class="flex-1 grid grid-cols-2 gap-x-6 text-sm sm:col-span-3 sm:grid-cols-2 lg:col-span-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                <dd class="mt-2 text-gray-500 dark:text-gray-50 text-xs">
                                                                    <?php
                                                                    if ($order->placed_at){
                                                                        echo date("d/m/Y \à\s h:i:s A", strtotime($order->placed_at)); 
                                                                    }
                                                                    else{
                                                                        echo "—";
                                                                    }
                                                            ...
                                                            <div class="flex-1 ltr:md:ml-6 rtl:md:mr-6 text-sm">
                                                                <div class="md:flex md:items-center md:justify-between md:space-x-4 rtl:space-x-reverse xl:pb-4">
                                                                        ...
                                                                        <div class="inline-block md:!flex text-gray-500 dark:text-gray-300 text-xs space-y-4 md:space-y-0 md:space-x-6 lg:space-x-12 rtl:space-x-reverse">
                                                                            ...
                                                                            <span class="flex">
                                                                                <div class="md:text-center">
                                                                                    ...
                                                                                    <?php elseif($item->refund && $item->refund->status === 'rejected_by_seller'): ?>
                                                                                        <p class="mt-2 text-[11px] text-red-500 font-medium">
                                                                                            <?php echo e(__('messages.t_seller_has_declined_ur_refund')); ?>

                                                                                            <br>
                                                                                            <span class="mt-2 text-[11px] text-green-500 font-medium cursor-pointer">
                                                                                            <?php echo e(__('messages.t_waiting_buyer_as_buyer')); ?>

                                                                                            </span>
                                                                                        </p>
                                                                                    <?php elseif($item->order->invoice && $item->order->invoice->status === 'rejected_by_seller'): ?>
                                                                                        <p class="mt-2 text-[11px] text-amber-500 font-medium">
                                                                                            <?php echo e(__('messages.t_seller_has_declined_ur_refund')); ?>
                                                                                    ...
                                                                                    <?php elseif($item->refund && $item->refund->status === 'accepted_by_seller'): ?>
                                                                                        <p class="mt-2 text-[11px] text-green-500 font-medium">
                                                                                            <?php echo e(__('messages.t_seller_has_accepted_ur_refund')); ?>

                                                                                        </p>
                                                                                    <?php elseif($item->order->invoice && $item->order->invoice->status === 'accepted_by_seller'): ?>
                                                                                        <p class="mt-2 text-[11px] text-green-500 font-medium">
                                                                                            <?php echo e(__('messages.t_seller_has_accepted_ur_refund')); ?>
                                                                                    ...
                                                                                    <?php elseif($item->refund && $item->refund->status === 'closed'): ?>
                                                                                        <p class="mt-2 text-[11px] text-red-500 font-medium">
                                                                                            <?php echo e(__('messages.t_subject_seller_refund_closed')); ?> <br>
                                                                                        </p>
                                                                                    <?php elseif($item->order->invoice && $item->order->invoice->status === 'closed'): ?>
                                                                                        <p class="mt-2 text-[11px] text-amber-500 font-medium">
                                                                                            <?php echo e(__('messages.t_subject_seller_refund_closed')); ?> <br>
                                                                                        </p>                                                                                        
                                                                                        ...
                                                                                        <?php switch($item->status):
                                                                                            ...
                                                                                            <?php case ('proceeded'): ?>
                                                                                                ...
                                                                                                <div id="orders-<?php echo e($order->uid); ?>-item-<?php echo e($item->id); ?>-status-proceeded" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                                                                    ...
                                                                                                    <?php echo date("d/m/Y \à\s h:i:s A", strtotime($item->proceeded_at));  ?>
                                                                                                </div>
                                                                                                <?php break; ?>
                                                                                            ...
                                                                                            <?php case ('waiting'): ?>
                                                                                                <p data-tooltip-target="orders-<?php echo e($order->uid); ?>-item-<?php echo e($item->id); ?>-status-proceeded" class="mt-2 text-[11px] text-green-500 font-medium cursor-pointer">
                                                                                                    <?php echo e(__('messages.t_waiting_buyer_as_buyer')); ?>
                                                                                            ...
                                                                                            <?php case ('delivered'): ?>
                                                                                                ...
                                                                                                <div id="orders-<?php echo e($order->uid); ?>-item-<?php echo e($item->id); ?>-status-delivered" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                                                                    ...
                                                                                                    <?php echo date("d/m/Y \à\s h:i:s A", strtotime($item->delivered_at));  ?>
                                                                                                </div>
                                                                                                <?php break; ?>
                                                                                            ...
                                                                                            <?php case ('canceled'): ?>
                                                                                                ...
                                                                                                <div id="orders-<?php echo e($order->uid); ?>-item-<?php echo e($item->id); ?>-status-canceled" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                                                                    ...
                                                                                                    <?php echo date("d/m/Y \à\s h:i:s A", strtotime($item->canceled_at));  ?>
                                                                                                </div>
                                                                                                <?php break; ?>
                                                                                            
                                                                                            
                                                                                            <?php case ('refunded'): ?>
                                                                                                <p data-tooltip-target="orders-<?php echo e($order->uid); ?>-item-<?php echo e($item->id); ?>-status-refunded" class="mt-2 text-[11px] text-green-500 font-medium cursor-pointer">
                                                                                                ...
                                                                                                <div id="orders-<?php echo e($order->uid); ?>-item-<?php echo e($item->id); ?>-status-refunded" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                                                                    ...
                                                                                                    <?php echo date("d/m/Y \à\s h:i:s A", strtotime($item->refunded_at));  ?>
                                                                    ...
                                                                    <div class="mt-4 flex space-x-3 md:mt-0">
                                                                        ...
                                                                        <a href="<?php echo e(url('messages/new', $item->owner?->username)); ?>" target="_blank" 
                                                                        class="finline-flex justify-center px-2 py-2 border border-gray-200 dark:border-zinc-700 shadow-sm text-xs font-medium rounded-full text-gray-700 
                                                                        dark:text-gray-300 bg-white dark:bg-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-900 focus:outline-none focus:ring-0">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1"> 
                                                                        ...
                                                                        <?php if($item->refund): ?>
                                                                            ...
                                                                            <a href="<?php echo e(url('account/refunds/details', $item->refund->uid)); ?>" target="_blank" 
                                                                            class="finline-flex justify-center px-2 py-2 border border-gray-200 dark:border-zinc-700 shadow-sm text-xs font-medium rounded-full text-gray-700 
                                                                            dark:text-gray-300 bg-white dark:bg-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-900 focus:outline-none focus:ring-0">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1"> 
                                                                        ...
                                                                        <?php else: ?>
                                                                            ...
                                                                            <?php if($can_refund): ?>
                                                                                ...
                                                                                <a href="<?php echo e(url('account/refunds/request', $item->uid)); ?>" target="_blank" 
                                                                                class="finline-flex justify-center px-2 py-2 border border-gray-200 dark:border-zinc-700 shadow-sm text-xs font-medium rounded-full text-gray-700 
                                                                                dark:text-gray-300 bg-white dark:bg-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-900 focus:outline-none focus:ring-0">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1"> 
                                                                                    <path d="M16 12h2v4h-2z"></path><path d="M20 7V5c0-1.103-.897-2-2-2H5C3.346 3 2 4.346 2 6v12c0 2.201 1.794 3 3 3h15c1.103 0 2-.897 2-2V9c0-1.103-.897-2-2-2zM5 5h13v2H5a1.001 1.001 0 0 1 0-2zm15 14H5.012C4.55 18.988 4 18.805 4 18V8.815c.314.113.647.185 1 .185h15v10z"></path>
                                                                        ...
                                                                        <?php if((in_array($item->status, ['proceeded', 'waiting', 'delivered']) AND !$item->refund)): ?>
                                                                        
                                                                            <a href="<?php echo e(url('account/orders/files?orderId=' . $order->uid . '&itemId=' . $item->uid)); ?>"  
                                                                            class="finline-flex justify-center px-2 py-2 border border-gray-200 dark:border-zinc-700 shadow-sm text-xs font-medium rounded-full text-gray-700 
                                                                            dark:text-gray-300 bg-white dark:bg-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-900 focus:outline-none focus:ring-0">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
                                                                        ...
                                                                        <?php if($item->status === 'pending' && $item->order->invoice && $item->order->invoice->status === 'paid'): ?>
                                                                            ...
                                                                            <button type="button" x-on:click="confirm('<?php echo e(__('messages.t_are_u_sure_u_want_to_cancel_service')); ?>') ? $wire.cancel('<?php echo e($item->uid); ?>') : ''" wire:loading.attr="disabled"
                                                                            wire:target="cancel('<?php echo e($item->uid); ?>')" 
                                                                            class="finline-flex justify-center px-2 py-2 border border-gray-200 dark:border-zinc-700 shadow-sm text-xs font-medium rounded-full text-gray-700 
                                                                            dark:text-gray-300 bg-white dark:bg-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-900 focus:outline-none focus:ring-0">
                                                                        ...
                                                                        <?php if( $item->status === 'delivered' && $item->is_finished ): ?>
                                                                            ...
                                                                            <a href="<?php echo e(url('account/reviews/create/' . $item->uid)); ?>"  
                                                                            class="finline-flex justify-center px-2 py-2 border border-gray-200 dark:border-zinc-700 shadow-sm text-xs font-medium rounded-full text-gray-700 
                                                                            dark:text-gray-300 bg-white dark:bg-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-900 focus:outline-none focus:ring-0">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1"> 
                                                                    ...
                                                                    <div class="inline-block md:!flex text-gray-500 dark:text-gray-300 text-xs space-y-4 md:space-y-0 md:space-x-6 lg:space-x-12 rtl:space-x-reverse">
                                                                        ...
                                                                        <span class="flex">
                                                                            <div class="md:text-center">
                                                                                ...
                                                                                <?php if($item->refund && $item->refund->status === 'rejected_by_admin'): ?>
                                                                                    <p class="mt-2 text-[11px] text-red-500 font-medium">
                                                                                        <?php echo e(__('messages.t_declined_by_admin')); ?>

                                                                                    </p>
                                                                                <?php elseif($item->refund && $item->refund->status === 'pending'): ?>
                                                                                    <p class="mt-2 text-[11px] text-red-500 font-medium">
                                                                                        <?php echo e(__('messages.t_dispute_opened')); ?>
...
<script>
    document.addEventListener("DOMContentLoaded", function(){
        ...
        ?>
            ...
            window.$wireui.notify({title: '<?php echo app('translator')->get('messages.t_success'); ?>', description: '<?php echo app('translator')->get('messages.t_order_has_marked_as_completed'); ?>',icon: 'success'});
        <?php
        }
        ?>
    });

</script><?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/main/account/orders/orders.blade.php ENDPATH**/ ?>