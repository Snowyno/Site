        ...
        <div class="bg-white dark:bg-zinc-800 justify-center pb-4 pt-5 px-4 rounded-md shadow-sm sm:align-middle sm:max-w-sm sm:p-6 sm:w-full mx-auto">
            ...
            <div class="mt-5 sm:mt-6">
                <!--<a href="<?php echo e($isFinished); ?>" class="inline-flex justify-center items-center w-full rounded uppercase tracking-widest border border-transparent shadow-sm px-4 py-3 bg-primary-600 font-medium text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-600 text-xs">!-->
                    <a href="https://p2win.com.br/seller/gigs" class="inline-flex justify-center items-center w-full rounded uppercase tracking-widest border border-transparent shadow-sm px-4 py-3 bg-primary-600 font-medium text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-600 text-xs">
...
} elseif ($_instance->childHasBeenRendered('l1412178697-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1412178697-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1412178697-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1412178697-1');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.overview');
    $html = $response->html();
    $_instance->logRenderedChild('l1412178697-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/main/create/create.blade.php ENDPATH**/ ?>