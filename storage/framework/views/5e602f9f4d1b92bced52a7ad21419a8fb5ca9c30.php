<div class="w-full">
    ...
    <div class="bg-white dark:bg-zinc-800 overflow-y-auto border !border-t-0 !border-b-0 dark:border-zinc-600">
        ...
        style="width: 30%;margin-top: 10px;margin-bottom: 10px; margin-left: 10px; float: left">
        <option selected="" <?php echo $toSel; ?>>Todos</option>
        <option value="1"   <?php echo $onSel; ?>>Ativo</option>
        <option value="2"   <?php echo $twSel; ?>>Verificado</option>
        <option value="3"   <?php echo $trSel; ?>>Pendente</option>
        <option value="4"   <?php echo $foSel; ?>>Banido</option>
        </select> 
        </form>
        ...
        <table class="w-full whitespace-nowrap old-tables" id="myTable">
...
<?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/admin/users/users.blade.php ENDPATH**/ ?>