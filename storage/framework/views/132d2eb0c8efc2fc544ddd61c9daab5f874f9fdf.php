...
} elseif ($_instance->childHasBeenRendered('uGR5kRJ')) {
    $componentId = $_instance->getRenderedChildComponentId('uGR5kRJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('uGR5kRJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uGR5kRJ');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('uGR5kRJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('jNHnb7f')) {
    $componentId = $_instance->getRenderedChildComponentId('jNHnb7f');
    $componentTag = $_instance->getRenderedChildComponentTagName('jNHnb7f');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jNHnb7f');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('jNHnb7f', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>