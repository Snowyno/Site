                ...
                <div x-data="{ open: true }" class="py-3">
                    ...
                    <div class="pt-6 px-4" x-show="open" style="display: none;">
                        <div class="space-y-4">
                            ...
                            <select class="form-select" name="category" id="category" wire:model.defer="category_id" wire:ignore name="category_id">
                            ...
                            <select class="form-select" name="subcategory" id="subcategory" wire:model.defer="subcategory_id" wire:ignore name="subcategory_id">
                            <option value="x" selected>Todas</option>
                            ...
                            <select class="form-select" name="subcategoryd" id="subcategoryd" wire:model.defer="subcategoryd_id" wire:ignore>
                            <option value="x" selected>Todas</option>
                                ...
                                ?>
                                    ...
                                    <div class="col-span-12 lg:col-span-6 md:col-span-6 sm:col-span-6 xl:col-span-4" >
                                        <div class="gig-card" dir="ltr">
                                            <div id="solOut" style="position: absolute;background-color: red;color: white;margin: 25px 190px 5px;transform: rotate(390deg);padding: 1px 15px 1px 15px;text-transform: uppercase;"><?php echo e(__('messages.t_sold_off')); ?></div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/main/categories/subcategory.blade.php ENDPATH**/ ?>