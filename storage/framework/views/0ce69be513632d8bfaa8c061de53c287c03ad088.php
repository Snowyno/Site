<div wire:id="c5hZduu0GmNFFMx6VAbF" class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-16 pb-24 space-y-8 min-h-screen">
    <div class="relative md:mx-auto " x-data="window.oZcfXWmBuWfxbIo" x-init="initialize()">
        ...
        <div class="bg-white dark:bg-zinc-800 shadow-sm ring-1 ring-gray-100 dark:ring-zinc-700 border border-gray-50 dark:border-zinc-700 rounded-xl px-4 py-4 lg:px-12 lg:py-12">
                        ...
                        <ol role="list" class="md:flex items-center space-x-2 rtl:space-x-reverse">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="<?php echo e(url('categories/' . utf8_decode(urldecode($gig->category->slug . '/' . $gig->slug)))); ?>" 
                                    class="ltr:ml-2 rtl:mr-2 text-sm font-medium text-gray-400 hover:text-gray-600" aria-current="page"><?php echo e($gig->name); ?></a>
                                </div>
                            </li>
            ...
            <div class="lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
                ...
                ?>
                <div id="solOut" style="z-index:999999999; font-size: 30px; position: absolute;background-color: red;color: white;margin: 25px 475px 5px;transform: rotate(390deg);padding: 1px 15px 1px 15px;text-transform: uppercase;"><?php echo e(__('messages.t_sold_off')); ?></div>
                <?php
                }
                ?>
                                        ...
                                        <ul class="splide__list">
                                            ...
                                            <?php $__currentLoopData = $gig->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="splide__slide dark:bg-zinc-700 bg-gray-200 object-contain">
                                                    <img src="<?php echo e(src($image->small)); ?>" alt="<?php echo e($gig->title); ?>" class="object-contain ">
                                                </li>
                ...
                <div class="max-w-2xl mx-auto mt-6 md:mt-14 sm:mt-16 lg:max-w-none lg:mt-0 lg:row-end-2 lg:row-span-2 lg:col-span-3">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                        ...
                        <span id="btn_buy_direct" wire:click="addToCart" onclick="$('#btn_buy_direct').hide(); gotocart();"
                        class="w-full bg-primary-100 border border-transparent rounded-md py-4 px-8 flex items-center justify-center text-[13px] font-medium text-primary-600 hover:bg-primary-200 focus:outline-none btnPurple">
                        <?php echo e(__('messages.t_direct_buy')); ?>
                        ...
                        <script>
                            function gotocart(){
                                ...
                                $(".fixed").hide();
                                $(".pointer-events-none").toggle();
                                $(".pointer-events-none").css("display", "none");
                                $("body").html("");
                             
                             
                             
                                $("body").prepend('<div id="allscreen" style="background-color: rgba(0, 0, 0, 0.5);width: 100vw;height: 100vw;z-index: 999999999999;"></div>');
                                $("body").remove();

                                setTimeout(() => {  
                                    window.location.href = "https://p2win.com.br/checkout";
                                }, 500);
                        ...
                        <a href="<?php echo e(url('messages/new', $gig->owner->username)); ?>" class="w-full bg-primary-100 border border-transparent rounded-md py-4 px-8 flex items-center justify-center text-[13px] font-medium text-primary-600 hover:bg-primary-200 focus:outline-none"><?php echo e(__('messages.t_contact_seller')); ?></a>
                ...
                <div class="w-full max-w-2xl mx-auto mt-16 lg:max-w-none lg:mt-0 lg:col-span-4">
                    <div x-data="Components.tabs()" @tab-click.window="onTabClick" @tab-keydown.window="onTabKeydown">
                        ...
                        <div id="tab-panel-reviews" class="-mb-10" x-data="Components.tabPanel(0)" aria-labelledby="tab-reviews" x-init="init()" x-show="selected" @tab-select.window="onTabSelect" role="tabpanel" tabindex="0">
                            ...
                            <div class="pt-6 dark:text-gray-300 quill-container text-base">
            ...
            <div class="mt-12 sm:mt-24" wire:ignore>
                ...
                <div id="slick-related-gigs" class="-mx-3" wire:ignore>
                    <?php $__currentLoopData = $related_gigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        if($gig->counter_sales == 0 OR $gig->orders_in_queue == 0 ){
                        ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/main/service/service.blade.php ENDPATH**/ ?>