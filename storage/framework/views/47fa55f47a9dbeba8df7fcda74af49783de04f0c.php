...
<?php
    //Verifica se disputa tem 3 dias ou mais, então cancela e devolve grana para comprador
    $date_now = date("Y-m-d h:i:s"); // this format is string comparable
    $date_end = date('Y-m-d h:i:s', strtotime($refund->created_at. ' + 3 days'));
...
<?php endif; ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 mb-10">
        ...
        <nav class="justify-between px-4 py-3 text-gray-700 border border-gray-100 rounded-lg shadow-sm sm:flex sm:px-5 bg-white dark:bg-zinc-800 dark:border-zinc-700 dark:shadow-none" aria-label="Breadcrumb">
                ...
                <?php
                    $timeouts = json_decode(json_encode($settings_timeouts), true);
                    //echo $timeouts['0']['timeoutVenda'];

                    $addingFiveMinutes= strtotime($refund->created_at.' + '.$timeouts['0']['timeoutVenda'].' minute');
                    
                ?>
                <span class="ltr:ml-3 rtl:mr-3" style="float: right !important;">
                <?php echo app('translator')->get('messages.t_act_til'); ?> <?php echo date('d/m/Y H:i:s', $addingFiveMinutes); ?>
                </span>  
        </nav>
        <?php endif; ?>
        <?php
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 mb-10">
            <nav class="justify-between px-4 py-3 text-gray-700 border border-gray-100 rounded-lg shadow-sm sm:flex sm:px-5 bg-white dark:bg-zinc-800 dark:border-zinc-700 dark:shadow-none" aria-label="Breadcrumb">
                    ...
                    <span class="ltr:ml-3 rtl:mr-3" style="float: right !important;">
                        Tempo para ação esgotado, o valor será devolvido ao comprador
                      <!-- <br> Agora: <?php // echo $date_now; ?>  - End: <?php //echo $date_end; ?> -->
                    </span>  
            </nav>
        </div>
        <?php            
...
</div><?php /**PATH /home/u991810173/domains/universalgamer.shop/public_html/resources/views/livewire/main/seller/refunds/options/details.blade.php ENDPATH**/ ?>