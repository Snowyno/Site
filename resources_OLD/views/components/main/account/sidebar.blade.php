...
{{-- Seller --}}
    <div class="border-b border-gray-100 dark:border-zinc-600">
        ...
        <a href="{{ url('start_selling') }}" class="{{ Request::is('start_selling') ? $link_active_class : $link_basic_class }} group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">

            {{-- icon --}}
            <svg class="{{ Request::is('start_selling') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"> <path stroke-linecap="round" stroke-linejoin="round" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/></svg>

            {{-- text --}}
            <span class="truncate text-sm font-semibold"> {{ __('messages.t_become_a_seller') }} </span>
        ...
        {{-- Buyer --}}
            @if (auth()->user()->account_type === 'seller')
            {{-- Seller dashboard --}}
            <a href="{{ url('seller/home') }}" class="{{ Request::is('seller/home') ? $link_active_class : $link_basic_class }} group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">
                {{-- icon --}}
                <svg class="{{ Request::is('seller/home') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"> <path stroke-linecap="round" stroke-linejoin="round" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/></svg>
                    
            {{-- text --}}
            <span class="truncate text-sm font-semibold"> {{ __('messages.t_seller_dashboard') }} </span>
            </a>
            @endif
