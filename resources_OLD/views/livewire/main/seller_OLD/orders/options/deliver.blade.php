        ...
        <div class="bg-white dark:bg-zinc-800 rounded-b-md">
            <div class="grid grid-cols-12 md:gap-x-6 gap-y-6 divide-x rtl:divide-x-reverse dark:divide-zinc-700">
                        ...
                        <div class="grid grid-cols-12 md:gap-x-6 gap-y-6 px-6">
                            ...
                            <div class="col-span-12">
                                ...
                                <div class="mt-2 relative">
                                    <input x-on:change="fileInputChanged" type="file" accept="video/*,image/*" class="block w-full text-xs text-gray-700 font-medium bg-gray-100 dark:bg-zinc-700 dark:text-gray-200 dark:border-zinc-700 rounded-md cursor-pointer focus:ring-0 focus:outline-none" />
                                </div>
                            ...
                            {{-- Submit --}}
                            <div class="col-span-12">
                                <input type="checkbox" class="dark:bg-transparent text-xs rounded border-2 dark:border-zinc-700 dark:placeholder-gray-300 dark:text-gray-200" name="checkbox" id="checkbox_id" value="1"/>
                                <label for="checkbox_id" class="text-xs">&nbsp;Ao clicar aqui, bla bla bla, aceita, bla bla bla</label>
                            </div>
                            <div class="col-span-12 mt-10 mb-8">
                                <x-forms.button action="submit" id="submit" x-bind:disabled="true" :text="__('messages.t_submit')" :block="true" />
                            </div>
                ...
                <div class="col-span-12 lg:col-span-6">
                    ...
                    <!-- CHAT TEXTS AREA -->
                    <div class="flex flex-col w-full h-full" style="max-height: 70%;">
                        ...
                        {{-- Conversation --}}
                        <div class="w-full">
                            <ul role="list" class="p-6" style="overflow: scroll !important; max-height: 40vh;" id="chat-with-seller-scrolled" >
                    ...
                    {{-- Send message --}}
                        @if (!$order->is_finished)
                            <div class="mt-auto w-full px-6 py-10 border-t bg-gray-50 dark:bg-zinc-700 dark:border-zinc-700 rounded-br-md" style="bottom: 10px !important; position: relative; max-height: 30% !important;">
