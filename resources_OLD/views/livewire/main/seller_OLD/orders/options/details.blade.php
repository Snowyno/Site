            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <?php
                        ...
                        if ($order->status == 'proceeded'){
                            echo  '<span class="text-xs font-normal">TIMELEFT: <span id="tempoQueFalta"></span></span><br><Br>';
                            //print_r($order);
                        }
                ...
                @if (!$order->is_finished && $order->order->invoice->status !== 'pending')
                    <div class="mt-5 flex xl:mt-0 xl:ltr:ml-4 xl:rtl:mr-4">
                        ...
                        {{-- Cancel order --}}
                        @if ($order->status === 'pending' || $order->status === 'proceeded')
                ...
                <dl>
                    ...
                    <div class="bg-gray-50 dark:bg-zinc-700 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-10">
                        ...
                        <dd class="mt-1 text-sm text-gray-500 dark:text-gray-200 sm:mt-0 sm:col-span-2">
                            <?php echo date("d/m/Y à\s H:i:s", strtotime( $order->placed_at )); ?>
                        </dd>
                    </div>
                            ...
                            @else
                                @switch($order->status)
                                    ...
                                    @case('delivered')
                                        ...
                                        <span class="text-sm text-gray-400 ltr:ml-4 rtl:mr-4"><?php echo date("d/m/Y à\s H:i:s", strtotime( $order->delivered_at )); ?></span>
                                        @break
                                    ...
                                    @case('refunded')
                                        ...
                                        <span class="text-sm text-gray-400 ltr:ml-4 rtl:mr-4"><?php echo date("d/m/Y à\s H:i:s", strtotime( $order->refunded_at )); ?></span>
                                        @break
                                    ...
                                    @case('proceeded')
                                        ...
                                        <span class="text-sm text-gray-400 ltr:ml-4 rtl:mr-4"><?php echo date("d/m/Y à\s H:i:s", strtotime( $order->proceeded_at )); ?></span>
                                        @break
                                    ...
                                    @case('canceled')
                                        ...
                                        <span class="text-sm text-gray-400 ltr:ml-4 rtl:mr-4"><?php echo date("d/m/Y à\s H:i:s", strtotime( $order->canceled_at )); ?> </span>
                                        @break
