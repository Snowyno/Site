					...
					<div class="rounded-lg border border-slate-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 shadow-sm p-3 flex flex-col justify-between">
						<div class="flex justify-between space-x-1 rtl:space-x-reverse">
							<p class="text-lg font-bold text-zinc-700 dark:text-zinc-100">
								...
								$completed_orders=10;
								$pending_orders=10;
								$orders_under_progress =10;
								$canceled_orders =10;
								
								$row = array();
								$row['permalink'] ='altasis';
								$row['title'] ='altasis';
								
								$latest_messages = array();
								$latest_messages[0] = 3;
								$latest_messages['link'] = "/".$row['permalink'];
								$latest_messages['title'] = $row['title'];

								
								
								$message['uid']= '123123';
								$message['avatar']='altasis';
								$message['username']='altasis';
								$message['message']['attachment']='altasis';
								$message['message']['body']='altasis';
