            ...
            <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:grid lg:grid-cols-12 lg:divide-y-0 lg:divide-x rtl:divide-x-reverse">
                ...
                <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8">
                        ...
                        {{-- Section header --}}
                        <div class="mb-114 lg:flex lg:items-center lg:justify-between">
                            <div class="flex-5 min-w-5">
                            ...
                            <div class="mt-5 flex lg:mt-0 lg:ltr:ml-4 lg:rtl:mr-4">
                                    ...
                                    <span class="block">
                                            <a href="{{ url('account/refunds/details', $item->refund->uid) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-zinc-600 rounded-sm shadow-sm text-xs font-bold tracking-wide text-gray-700 dark:text-gray-200 bg-white dark:bg-zinc-600 hover:bg-gray-50 dark:hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-offset-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="ltr:-ml-1 ltr:mr-2 rtl:-mr-1 rtl:ml-2 h-4 w-4 text-gray-500 dark:text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"> <path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>
                                    ...
                                    @else
                                        <span class="ltr:ml-3 rtl:mr-3">
                                            ...
                                            <button id="work_btn_id_dis" type="button" onclick="verifcaCheckbox();"
                                            class="inline-flex items-center px-4 py-2 border border-transparent rounded-sm shadow-sm text-xs font-bold tracking-wide text-gray-900 bg-zinc-600 hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-zinc-500">
                                                <svg class="ltr:-ml-1 ltr:mr-2 rtl:-mr-1 rtl:ml-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"> 
                                            ...
                                            <button style="display: none !important;" id="work_btn_id_en" x-on:click='confirm("{{ __('messages.t_are_sure_completed_work_buyer') }}") ? $wire.completed() : "" ' wire:loading.attr="disabled" wire:target="completed" type="button" name="recebido" 
                                            class="inline-flex items-center px-4 py-2 border border-transparent rounded-sm shadow-sm text-xs font-bold tracking-wide text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                                                <svg class="ltr:-ml-1 ltr:mr-2 rtl:-mr-1 rtl:ml-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"> 
                                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/> </svg>
                                                {{ __('messages.t_work_completed') }}
                                            </button>
                                            <div class="col-span-12">
                                                ...
                                                <label for="checkbox_id" class="text-xs">&nbsp;Ao clicar aqui, bla bla bla, aceita, bla bla bla</label>
                                            </div>
                                        </span>
                                    </span>
                                    @endif
                        ...
                        <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                            ...
                            <div class="col-span-12 xl:col-span-8">
                                <section>
                                    <div id="chat-with-seller-scrolled" class="rounded-lg bg-white dark:bg-zinc-700 overflow-hidden border border-gray-200 dark:border-zinc-600" style="max-height: 35vh; overflow: scroll !important;">
                                        ...
                                        <div>
                                            ...
                                            {{-- Chat messages --}}
                                            <div class="w-full">
                                                <ul role="list" class="py-6 px-8" id="ulDoChat">
                ...
                <div class="space-y-6 pb-16">
                    ...
                    <div class="mb-14">
                        <div class="aspect-w-10 aspect-h-7 block w-full overflow-hidden rounded-md">
                            <img src="{{ placeholder_img() }}" data-src="{{ src($item->gig->thumbnail) }}" alt="{{ $item->gig->title }}" class="lazy object-cover">
                        </div>
                        <div class="mt-4">
                            <div>
                                <a href="{{ url('service', $item->gig->slug) }}" target="_blank" class="text-base font-bold tracking-wide text-gray-900 dark:text-gray-200 hover:text-primary-600">
                                    {{ $item->gig->title }}
                                </a>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <dl class="mt-2 divide-y divide-gray-200 border-t border-b border-gray-200 dark:divide-zinc-700 dark:border-zinc-700">
                            ...
                            <div class="flex justify-between py-3 text-sm font-medium">
                                ...
                                <dd class="text-gray-900 dark:text-gray-200  font-extrabold">@money($item->profit_value, settings('currency')->code, true)</dd>
                            </div>
...
<script>
    ...
    function rolllChatToEnd(){
        ...
        scroll_to_bottom.scrollTop = scroll_to_bottom.scrollHeight+300;
    }
    ...
    function verifcaCheckbox(){
        ...
        if(!checado){
            alert('Você precisa aveitar as condições!')
        }
    }
