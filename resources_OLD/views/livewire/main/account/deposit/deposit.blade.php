                                            ...
                                            <div class="grid grid-cols-12 md:gap-x-5 gap-y-5">
                                                ...
                                                <div class="col-span-12">
                                                    ...
                                                    <div class="relative w-full">
                                                        <input wire:model.debounce.500ms="amount" inputmode="numeric" type="text" id="deposit-amount-input" class="border border-gray-300 text-gray-900 text-sm rounded-lg font-medium focus:ring-primary-500 focus:border-primary-500 block w-full ltr:pr-12 rtl:pl-12 p-4  dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="0.00" required
                                                                model="price"
                                                                id="value"
                                                                type="number"
                                                                min="0.00"
                                                ...
                                                $('#deposit-amount-input').mask('0000000.00', { reverse: true });
                                                </script>
                                                {{-- Paymob --}}
                                                @if ($selected === 'paymob')
