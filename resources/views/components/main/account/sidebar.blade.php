...
<nav class="w-full {{ $class ? $class : '' }}">
    ...
    <div class="border-b border-gray-100 dark:border-zinc-600">
        ...
        {{-- Withdrawals --}}
        <a href="{{ url('seller/withdrawals') }}" class="{{ Request::is('seller/withdrawals') ? $link_active_class : $link_basic_class }} group ltr:border-l-4 rtl:border-r-4 px-5 py-3 flex items-center text-sm font-medium">

        {{-- icon --}}
        <svg class="{{ Request::is('account/withdrawals') ? $icon_active_class : $icon_basic_class }} flex-shrink-0 ltr:-ml-1 rtl:-mr-1 ltr:mr-3 rtl:ml-3 h-5 w-5" xmlns="http://www.w3.org/2000/svg" 
        fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"> 
        ...
        {{-- text --}}
        <span class="truncate text-sm font-semibold"> {{ __('messages.t_withdrawal') }} </span>
