            ...
            <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 py-6">
                ...
                <div class="col-span-12 md:col-span-6">
                    ...
                    @foreach ($categorias as $cat)
                        <option onclick="selecionaCategoria(<?php echo $cat['id']; ?>);"  value="{{$cat['id']}}">{{ $cat['name'] }}</option>
                    @endforeach
                    </select>
                ...
                <div class="col-span-12 md:col-span-6">
                    ...
                    @foreach ($subcategorias as $subcat)
                        <option onclick="selecionaSubCategoria(<?php echo $subcat['id']; ?>);"  class="subcategoria sub_parent_{{$subcat['parent_id']}}" value="{{$subcat['id']}}">{{ $subcat['name'] }}</option>
                    @endforeach
                    </select>
                ...
                <div class="col-span-12 md:col-span-6">
                    ...
                    @foreach ($subcategoriasd as $subcatd)
                        <option onclick="selecionaSubCategoriad(<?php echo $subcatd['id']; ?>);" class="subcategoriad subd_parent_{{$subcatd['parent_id']}}" value="{{$subcatd['id']}}">{{ $subcatd['name'] }}</option>
                    @endforeach
                    </select>
                    </div>
                ...
                <label for="text-input-component-id-delivery_time" class="block text-[0.8125rem] font-medium tracking-wide text-gray-700 dark:text-white">Prazo de Entrega</label>
                    <div class="mt-2 relative">
                        ...
                        name="text-input-component-id-delivery_time" id="text-input-component-id-delivery_time">
                            ...
                            <option value="1" disabled>1 dia  (Em breve)</option>
                            <option value="2" disabled>2 dias (Em breve)</option>
                        </select>
                    </div> 
                </div>
            </div>
