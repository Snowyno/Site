                                        ...
                                        <div>
                                            ...
                                            <dl class="mt-2 divide-y divide-gray-200 border-t border-b border-gray-200 dark:divide-zinc-700 dark:border-zinc-700">
                                                ...
                                                <div class="flex justify-between py-3 text-sm font-medium">
                                                    ...
                                                    <dd class="text-gray-900 dark:text-gray-200  font-extrabold">{{ __($order->order->buyer->username) }}</dd>
                                                </div>
                                                ...
                                                <div class="flex justify-between py-3 text-sm font-medium">
                                                    ...
                                                    <dd class="text-gray-900 dark:text-gray-200">
                                                        ...
                                                        {{-- Refund --}}
                                                        @if ($order->refund && $order->refund->status === 'closed')
                                                        ...
                                                        @else
                                                            @switch($order->status)
                                                                ...
                                                                @case('waiting')
                                                                    <span class="text-gray-600 text-sm font-medium">{{ __('messages.t_waiting_buyer') }}</span>
                                                                @break
                                                            @endswitch
                                                        @endif                                                            
                                                    </dd>
                                                ...
                                                <div class="flex justify-between py-3 text-sm font-medium">
                                                    ...
                                                    <dd class="text-gray-900 dark:text-gray-200  font-extrabold">{{ __($order->quantity) }}</dd>
                                                </div>
                                                {{-- Amount --}}
                                                <div class="flex justify-between py-3 text-sm font-medium">
                                                    <dt class="text-gray-500 dark:text-gray-400">{{ __('messages.t_amount_lucro') }}</dt>
                                                    <dd class="text-gray-900 dark:text-gray-200  font-extrabold">@money($order->total_value, settings('currency')->code, true)</dd>
                                                </div>
                                                ...
                                                @if (!$order->is_finished && $order->status === 'refunded')
                                                {{-- Refund date --}}
                                                <!--
                                                <div class="flex justify-between py-3 text-sm font-medium">
                                                    <dt class="text-gray-500 dark:text-gray-400">{{ __('messages.t_refund_date') }}</dt>
                                                    <dd class="text-gray-900 dark:text-gray-200">{{ format_date($order->created_at, 'ago') }}</dd>
                                                </div>
                                                -->
                                                @endif
                                ...
                                <div class="row mx-1 my-1 px-1 py-1 border border-gray-200 dark:border-zinc-600 rounded-lg ">
                                    <div class="col-2 py-3">
                                        <center>
                                            ...
                                            @else
                                                @if (!$order->is_finished && $order->status === 'pending')
                                                <img src="https://p2win.com.br/public/img/order/order_status_img/pending.png" />
                                                @endif
                                                @if (!$order->is_finished && $order->status === 'proceeded')
                                                <img src="https://p2win.com.br/public/img/order/order_status_img/pending.png" />
                                                @endif
                                                @if (!$order->is_finished && $order->status === 'waiting')
                                                <img src="https://p2win.com.br/public/img/order/order_status_img/pending.png" />
                                                @endif
                                                @if ($order->is_finished && $order->status === 'delivered')
                                                <img src="https://p2win.com.br/public/img/order/order_status_img/delivered.png" />
                                                @endif
                                                @if (!$order->is_finished && $order->status === 'canceled')
                                    ...
                                    <div class="col-10 px-3 py-3">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_waiting_buyer') }}</p>
                                    </div>
                                    @else
                                        @if (!$order->is_finished && $order->status === 'pending')
                                        ...
                                        <div class="col-10 px-3 py-3">
                                            <h2 class="text-base leading-6 font-bold text-gray-900 dark:text-gray-100">{{ __('messages.t_in_the_waiting') }}</h2>
                                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_waiting_buyer') }}</p>
                                        </div>
                                        @endif
                                        ...
                                        <div class="col-10 px-3 py-3">
                                            <h2 class="text-base leading-6 font-bold text-gray-900 dark:text-gray-100">{{ __('messages.t_in_the_process') }}</h2>
                                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_waiting_for_seller_as_seller') }}</p>
                                        </div>
                                        @endif
                                        @if ($order->is_finished && $order->status === 'delivered')
                                    ...
                                    <div class="col-12 px-3 py-1">
                                        ...
                                        ?>
                                            <div class="flex items-center mb-8 text-blue-500">
                                                ...
                                                {{ __('messages.t_order_item_will_mark_done_after_1_week') }} <?php echo date("d/m/Y \à\s h:i:s A", strtotime($order->delivered_at));  ?>
                                                </span>
    ...
    @elseif (!$order->is_finished)
        <div class="grid grid-cols-12 md:gap-x-6 gap-y-10">
            ...
            <div class="col-span-12" wire:ignore>
                ...
                <x-forms.uploader model="files" id="uploader_files" :extensions="['rar', 'zip','png', 'jpeg', 'jpg', 'mp4', 'm4v', 'ogg']"
                accept="*" size="500000"
                max="1" />
