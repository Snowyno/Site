<header class="bg-white shadow-sm w-full z-40 transition-all duration-200">
   <div x-data="window.TTRjRvxLbHzaKxW" style="position: fixed; min-width: 100vw; background: white;">
        ...
        <nav class="relative container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 justify-between items-center h-20 flex">
            ...
            <div class="w-full hidden lg:block">   
                <div class="relative max-w-md" x-data="{ open: false }">
                    ...
                    {{-- Input --}}
                    <input wire:model.debounce.500ms="q" wire:keydown.enter="enter" x-ref="search" x-on:click="open = true" type="search" class="block p-2.5 w-full z-20 text-sm text-gray-900  bg-white  rounded border border-gray-300  focus:ring-0 focus:border-gray-500" placeholder="{{ __('messages.t_what_service_are_u_looking_for_today') }}" required>
            ...
            <div class="min-w-fit ltr:sm:ml-10 rtl:sm:mr-10 flex items-center font-medium text-sm transition-all duration-200">
                    ...
                    <div 
                        ...
                        <div class="bg-white  ring-1 ring-black ring-opacity-5 rounded divide-y divide-gray-100">
                            <div class="p-2 space-y-1">
                                ...
                                {{-- Explore gigs --}}
                                <a href="{{ url('search') }}" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700   ">
                                    <span>@lang('messages.t_explore_gigs')</span>
                                </a>

                                {{-- Explore projects --}}
                                @if (settings('projects')->is_enabled)
                                    <a href="{{ url('explore/projects') }}" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700   ">
                ...
                {{-- Become a seller --}}
                @guest
                    <a href="{{ url('start_selling') }}" class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 px-4 hidden md:block  ">
                ...
                @auth
                    ...
                    @if (auth()->user()->account_type === 'seller' && !Illuminate\Support\Str::of(request()->path())->startsWith('seller'))
                        ...
                        {{-- Switch selling --}}
                        <a href="{{ url('seller/home') }}" class="text-primary-600 hover:text-primary-700 transition-colors duration-300 py-2 px-4 hidden lg:block  ">
                    ...
                    @elseif (auth()->user()->account_type === 'seller' && Illuminate\Support\Str::of(request()->path())->startsWith('seller'))
                        ...
                        {{-- Switch buying --}}
                        <a href="{{ url('/') }}" class="text-primary-600 hover:text-primary-700 transition-colors duration-300 py-2 px-4 hidden lg:block  ">
                ...
                {{-- Sign in --}}
                @guest
                    <a href="{{ url('auth/login') }}" class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 px-4 hidden md:block  ">
                ...
                {{-- Join --}}
                @guest
                    <a href="{{ url('auth/register') }}" class="py-2 px-4 text-primary-600 hover:text-primary-800 transition-colors duration-300 rounded-full hidden md:inline-block  ">
                ...
                {{-- Messages --}}
                @auth
                     <!--<a href="{{ url('inbox') }}" class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 relative ltr:ml-4 rtl:mr-4 md:!mx-4   hidden md:block">-->

                 
                    <a href="{{ url('messages') }}" class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 relative ltr:ml-4 rtl:mr-4 md:!mx-4   hidden md:block">
                            ...
                            class="absolute top-full ltr:right-0 rtl:left-0 w-60 mt-3 bg-white  rounded-lg shadow-md ring-1 ring-gray-900 ring-opacity-5 font-normal text-sm text-gray-900 divide-y divide-gray-100  z-40">
                                ...
                                <div class="py-1.5 px-3.5">
                                    ...
                                    @if (auth()->user()->account_type === 'buyer')
                                        ...
                                        <a href="{{ url('start_selling') }}"
                                            ...
                                            <span
                                                class="font-semibold text-xs text-gray-700  group-hover:text-primary-600 ">{{ __('messages.t_become_a_seller') }}</span>
                                        </a>
                                    @endif
                                    ...
                                    @if (auth()->user()->account_type === 'seller')
                                        ...
                                        <a href="{{ url('seller/home') }}"
                                            ...
                                            <span
                                                class="font-semibold text-xs text-gray-700  group-hover:text-primary-600 ">{{ __('messages.t_seller_dashboard') }}</span>
                                        </a>
                                    @endif
                                ...
                                <div class="py-1.5 px-3.5">
                                    ...
                                    <a href="{{ url('profile', auth()->user()->username) }}"
                                        ...
                                        <span
                                            class="font-semibold text-xs text-gray-700  group-hover:text-primary-600 ">{{ __('messages.t_view_profile') }}</span>
                                    </a>
                                    ...
                                    <a href="{{ url('account/profile') }}"
                                        ...
                                        <span
                                            class="font-semibold text-xs text-gray-700  group-hover:text-primary-600 ">{{ __('messages.t_edit_profile') }}</span>
                                    </a>
                                    ...
                                    <a href="{{ url('account/settings') }}"
                                        ...
                                        <span
                                            class="font-semibold text-xs text-gray-700  group-hover:text-primary-600 ">{{ __('messages.t_account_settings') }}</span>
                                    </a>
                                    ...
                                    <a href="{{ url('account/password') }}"
                                        ...
                                        <span class="font-semibold text-xs text-gray-700  group-hover:text-primary-600 ">{{ __('messages.t_update_password') }}</span>
                                    </a>
                                ...
                                <div class="py-1.5 px-3.5">
                                    ...
                                    <a href="{{ url('account/deposit') }}" class="group flex items-center py-1.5 group-hover:text-primary-600">
                                        ...
                                        <span class="font-semibold text-xs text-gray-700  group-hover:text-primary-600 ">{{ __('messages.t_deposit') }}</span>
                                    </a>

                                    {{-- Withdrawals --}}
                                    <a href="{{ url('seller/withdrawals') }}" class="group flex items-center py-1.5 group-hover:text-primary-600">
                                    <svg class="text-slate-500 dark:text-zinc-300 flex-shrink-0 h-5.5 w-5.5 ltr:mr-3.5 rtl:ml-3.5 -mt-[1px] group-hover:text-slate-700 dark:group-hover:text-zinc-200" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" version="1.1"> <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <rect x="0" y="0" width="24" height="24"></rect> <circle fill="currentColor" opacity="0.3" cx="20.5" cy="12.5" r="1.5"></circle> <rect fill="currentColor" opacity="0.3" transform="translate(12.000000, 6.500000) rotate(-15.000000) translate(-12.000000, -6.500000) " x="3" y="3" width="18" height="7" rx="1"></rect> <path d="M22,9.33681558 C21.5453723,9.12084552 21.0367986,9 20.5,9 C18.5670034,9 17,10.5670034 17,12.5 C17,14.4329966 18.5670034,16 20.5,16 C21.0367986,16 21.5453723,15.8791545 22,15.6631844 L22,18 C22,19.1045695 21.1045695,20 20,20 L4,20 C2.8954305,20 2,19.1045695 2,18 L2,6 C2,4.8954305 2.8954305,4 4,4 L20,4 C21.1045695,4 22,4.8954305 22,6 L22,9.33681558 Z" fill="currentColor"></path> </g></svg>
                                        <span class="font-semibold text-xs text-gray-700  group-hover:text-primary-600 ">{{ __('messages.t_withdrawal') }}</span>
                                    </a>
                                    ...
                                    <a href="{{ url('account/orders') }}"
                                        ...
                                        <span
                                            class="font-semibold text-xs text-gray-700  group-hover:text-primary-600 ">{{ __('messages.t_my_orders') }}</span>
                                    </a>
                                    ...
                                    <a href="{{ url('messages') }}"
                                        ...
                                        <span
                                            class="font-semibold text-xs text-gray-700  group-hover:text-primary-600 ">{{ __('messages.t_messages') }}</span>
                                    </a>
                                    ...
                                    <a href="{{ url('account/reviews') }}" class="group flex items-center py-1.5 group-hover:text-primary-600">
                                        ...
                                        <span class="font-semibold text-xs text-gray-700  group-hover:text-primary-600 ">{{ __('messages.t_reviews') }}</span>
                                    </a>
                                    ...
                                    <a href="{{ url('account/refunds') }}" class="group flex items-center py-1.5 group-hover:text-primary-600">
                                        ...
                                        <span class="font-semibold text-xs text-gray-700  group-hover:text-primary-600 ">{{ __('messages.t_refunds') }}</span>
                                    </a>
                                ...
                                <div class="py-1.5 px-3.5">
                                    ...
                                    @if (auth()->user()->status !== 'verified')
                                        <a href="{{ url('account/verification') }}"
                                            ...
                                            <span
                                                class="font-semibold text-xs text-gray-700  group-hover:text-primary-600 ">{{ __('messages.t_verification_center') }}</span>
                                        </a>
                                    @endif
                                    ...
                                    <a href="{{ url('auth/logout') }}"
                                        ...
                                        <span
                                            class="font-semibold text-xs text-gray-700  group-hover:text-primary-600 ">{{ __('messages.t_logout') }}</span>
                                    </a>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 hidden md:block">
                ...
                @foreach ($categories as $category)
                    ...
                    <li class="inline-block flex-shrink-0 border-b-2 border-transparent hover:border-primary-600 focus:outline-none focus:ring-0 relative">
                        ...
                        @if (count($category->subcategories))
                            <button data-popover-target="popover-subcategories-{{ $category->uid }}" data-popover-trigger="hover" class="block text-[13px] font-medium text-gray-700   group-hover:text-primary-600 py-2 focus:outline-none focus:ring-0">
                                {{ $category->name }}
                            </button>
                        @else
            ...
            @foreach ($categories as $category)
                @if (count($category->subcategories))
                    <div data-popover id="popover-subcategories-{{ $category->uid }}" data-popover-placement="bottom" role="tooltip" class="absolute z-10 invisible inline-block w-64 text-sm font-light text-gray-500 transition-opacity duration-300 bg-white rounded-md shadow-xl opacity-0  ">
            ...
            <div 
                ...
                <div @class(['w-full overflow-auto h-full', 'pt-5' => auth()->check()])>
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        {{-- Messages --}}
                        @auth
                            <!--<a href="{{ url('inbox') }}" class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 relative mx-4   md:hidden">-->
                            <a href="{{ url('messages') }}" class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 relative mx-4   md:hidden">
                                <svg class="text-gray-400 hover:text-gray-700 h-6 w-6  " stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M20 4H4c-1.103 0-2 .897-2 2v12c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2zm0 2v.511l-8 6.223-8-6.222V6h16zM4 18V9.044l7.386 5.745a.994.994 0 0 0 1.228 0L20 9.044 20.002 18H4z"></path></svg>
                                @if ($new_messages)
                                    <span class="flex absolute h-2 w-2 top-0 ltr:right-0 rtl:left-0 mt-0 ltr:-mr-1 rtl:-ml-1">
                                        <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary-400 opacity-75"></span>
                    ...
                    {{-- Authenticated user --}}
                    @auth
                        <x-main.account.sidebar class="border-b border-gray-100  mb-[14px]" />
                    @endauth

                    {{-- Sign in --}}
                    @guest
                        <a href="{{ url('auth/login') }}" class="py-2 px-5 block text-gray-500  font-semibold text-sm">
                            @lang('messages.t_sign_in')
                        </a>
                    @endguest
                    ...
                    @if (auth()->guest() || ( auth()->check() && auth()->user()->account_type !== 'seller' ))
                        <a href="{{ url('start_selling') }}" class="py-2 px-5 block text-gray-500  font-semibold text-sm">
                            @lang('messages.t_become_a_seller')
                        </a>
                    @endif

                    {{-- Explore gigs --}}
                    <a href="{{ url('search') }}" class="py-2 px-5 block text-gray-500  font-semibold text-sm">
                    ...
                    {{-- Home --}}
                    <a href="{{ url('/') }}" class="py-2 px-5 flex items-center text-gray-500  font-semibold text-sm">
                    ...
                    {{-- Contact us --}}
                    <a href="{{ url('help/contact') }}" class="py-2 px-5 flex items-center text-gray-500  font-semibold text-sm">
                    ...
                    <div class="pt-8 px-6 lg:px-6 w-full sm:flex sm:justify-between sm:items-center">
                        <div class="flex justify-center sm:justify-left">
                            <h3 class="inline-flex items-center font-semibold">
                                <span class="text-base ">@lang('messages.t_notifications')</span>
                            </h3>
                        </div>
                    </div>
                                    ...
                                    <div class="flex items-center bg-slate-100 px-4 py-2 rounded">
                                        ...
                                        <div class="ltr:ml-3 rtl:mr-3 w-0 flex-1">
                                            ...
                                            <div class="mt-2 flex space-x-7 rtl:space-x-reverse">
                                                ...
                                                {{-- View --}}
                                                <a href="{{ $n->action }}" class="bg-transparent rounded-md text-primary-600 hover:text-primary-700 focus:outline-none text-xs tracking-wide ">
                                                    {{ __('messages.t_view') }}
                                                </a>
                                                
                                                {{-- Mark as read --}}
                                                <button wire:click="readNotification('{{ $n->uid }}')" wire:loading.attr="disabled" wire:target="read('{{ $n->uid }}')" type="button" class="bg-transparent rounded-md text-gray-700 hover:text-gray-500 focus:outline-none text-xs tracking-wide ">
                                                    {{-- Loading indicator --}}
