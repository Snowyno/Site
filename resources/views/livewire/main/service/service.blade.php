    ...
    <div class="relative md:mx-auto " x-data="window.oZcfXWmBuWfxbIo" x-init="initialize()">
        ...
        <div class="bg-white dark:bg-zinc-800 shadow-sm ring-1 ring-gray-100 dark:ring-zinc-700 border border-gray-50 dark:border-zinc-700 rounded-xl px-4 py-4 lg:px-12 lg:py-12">
                        ...
                        <ol role="list" class="md:flex items-center space-x-2 rtl:space-x-reverse">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ url('categories/' . utf8_decode(urldecode($gig->category->slug . '/' . $gig->slug))) }}" 
                                    class="ltr:ml-2 rtl:mr-2 text-sm font-medium text-gray-400 hover:text-gray-600" aria-current="page">{{ $gig->name }}</a>
                                </div>
                            </li>
            ...
            <div class="lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
                ...
                ?>
                <div id="solOut" style="z-index:999999999; font-size: 30px; position: absolute;background-color: red;color: white;margin: 25px 475px 5px;transform: rotate(390deg);padding: 1px 15px 1px 15px;text-transform: uppercase;">{{ __('messages.t_sold_off') }}</div>
                <?php
                }
                ?>
                                        ...
                                        <ul class="splide__list">
                                            ...
                                            @foreach ($gig->images as $image)
                                                <li class="splide__slide dark:bg-zinc-700 bg-gray-200 object-contain">
                                                    <img src="{{ src($image->small) }}" alt="{{ $gig->title }}" class="object-contain ">
                                                </li>
                                            @endforeach
                ...
                <div class="max-w-2xl mx-auto mt-6 md:mt-14 sm:mt-16 lg:max-w-none lg:mt-0 lg:row-end-2 lg:row-span-2 lg:col-span-3">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                        ...
                        {{-- Contact seller --}}
                        <a href="{{ url('messages/new', $gig->owner->username) }}" class="w-full bg-primary-100 border border-transparent rounded-md py-4 px-8 flex items-center justify-center text-[13px] font-medium text-primary-600 hover:bg-primary-200 focus:outline-none">{{ __('messages.t_contact_seller') }}</a>
