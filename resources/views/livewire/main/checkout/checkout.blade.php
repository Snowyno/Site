                        ...
                        <div class="w-full mt-14" wire:key="checkout-key-summary">
                            ...
                            @if ($payment_method === 'wallet' && auth()->user()->balance_available >= $exchange_total_amount)
                                <div class="w-full">
                                    ...
                                    {{-- Place order button --}}
                                    <div class="mt-8">
                                        <x-forms.button action="checkout({{ $this->totalApagar }} )" :text="__('messages.t_pay')" :block="true" />
                                    </div>
                                </div>
                            @endif
                            ...
                            @if ($payment_method === 'offline' && settings('offline_payment')->is_enabled)
                                <div class="w-full">
                                    ...
                                    {{-- Place order button --}}
                                    <div class="mt-8">
                                        <x-forms.button action="checkout({{ $this->totalApagar }} )" :text="__('messages.t_place_order')" :block="true" />
                                    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function(){
            ...
            ?>
                ...
                window.$wireui.notify({title: '@lang('messages.t_success')', description: '@lang('messages.t_cupon_is_valid')',icon: 'success'});
            <?php
            }
            ?>
            ...
            ?>
                ///livewire mostra notificações usando a func abaixo com js
                window.$wireui.notify({title: '@lang('messages.t_rejected')', description: '@lang('messages.t_cupon_is_invalid')',icon: 'error'});
            <?php
            }
            else if($used_cupon){
            ?>
            ///livewire mostra notificações usando a func abaixo com js
            window.$wireui.notify({title: '@lang('messages.t_rejected')', description: '@lang('messages.t_cupon_already_used')',icon: 'error'});
            <?php
            }
            ?>
