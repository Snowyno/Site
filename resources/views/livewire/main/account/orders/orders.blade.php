                            ...
                            <div class="w-full mb-6">
                                ...
                                <div>
                                    ...
                                    <div class="form-group row">
                                        <label for="statusFilter" class="col-md-6 col-form-label text-md-right">{{ __('messages.t_show_items_with_status') }}:</label> 
                                        <div class="col-md-6">
                                            <select class="form-control" id="statusFilterSelect"  name="statusFilterSelect" onchange="changeFilter();">
                                                <option value="todos" <?php echo (!isset($_GET['statusFilter'])) ? "selected" : ""; ?>> @lang('messages.t_all') </option>
                                                <option value="dispute_opened" <?php echo (isset($_GET['statusFilter']) AND $_GET['statusFilter'] == "dispute_opened") ? "selected" : ""; ?>>@lang('messages.t_dispute_opened')</option>
                                                <option value="pending" <?php echo (isset($_GET['statusFilter']) AND $_GET['statusFilter'] == "pending") ? "selected" : ""; ?>> @lang('messages.t_pending') </option>
                                                <option value="proceeded" <?php echo (isset($_GET['statusFilter']) AND $_GET['statusFilter'] == "proceeded") ? "selected" : ""; ?>> @lang('messages.t_proceed') </option>
                                                <option value="delivered" <?php echo (isset($_GET['statusFilter']) AND $_GET['statusFilter'] == "delivered") ? "selected" : ""; ?>> @lang('messages.t_delivered') </option>
                                                <option value="canceled" <?php echo (isset($_GET['statusFilter']) AND $_GET['statusFilter'] == "canceled") ? "selected" : ""; ?>> @lang('messages.t_canceled') </option>
                                                <option value="refunded" <?php echo (isset($_GET['statusFilter']) AND $_GET['statusFilter'] == "refunded") ? "selected" : ""; ?>> @lang('messages.t_refunded')</option>
                                                            ...
                                                            <div class="flex-1 ltr:md:ml-6 rtl:md:mr-6 text-sm">
                                                                <div class="md:flex md:items-center md:justify-between md:space-x-4 rtl:space-x-reverse xl:pb-4">
                                                                        ...
                                                                        <div class="inline-block md:!flex text-gray-500 dark:text-gray-300 text-xs space-y-4 md:space-y-0 md:space-x-6 lg:space-x-12 rtl:space-x-reverse">
                                                                            ...
                                                                            <span class="flex">
                                                                                <div class="md:text-center">
                                                                                    ...
                                                                                    {{-- Refund rejected by seller --}}
                                                                                    @elseif ($item->refund && $item->refund->status === 'rejected_by_seller')
                                                                                        <p class="mt-2 text-[11px] text-red-500 font-medium">
                                                                                            {{ __('messages.t_seller_has_declined_ur_refund') }}
                                                                                            <br>
                                                                                            <span class="mt-2 text-[11px] text-green-500 font-medium cursor-pointer">
                                                                                            {{ __('messages.t_waiting_buyer_as_buyer') }}
                                                                                            </span>
                                                                                        </p>
                                                                                    @elseif ($item->order->invoice && $item->order->invoice->status === 'rejected_by_seller')
                                                                                        <p class="mt-2 text-[11px] text-amber-500 font-medium">
                                                                                            {{ __('messages.t_seller_has_declined_ur_refund') }}
                                                                                            <br>
                                                                                            <span class="mt-2 text-[11px] text-green-500 font-medium cursor-pointer">
                                                                                    ...
                                                                                    {{-- Refund accepted by seller --}}
                                                                                    @elseif ($item->refund && $item->refund->status === 'accepted_by_seller')
                                                                                        <p class="mt-2 text-[11px] text-green-500 font-medium">
                                                                                            {{ __('messages.t_seller_has_accepted_ur_refund') }}
                                                                                        </p>
                                                                                    @elseif ($item->order->invoice && $item->order->invoice->status === 'accepted_by_seller')
                                                                                        <p class="mt-2 text-[11px] text-green-500 font-medium">
                                                                                            {{ __('messages.t_seller_has_accepted_ur_refund') }}
                                                                                        </p>              
                                                                                        
                                                                                    {{-- Refund closed --}}
                                                                                    @elseif ($item->refund && $item->refund->status === 'closed')
                                                                                        <p class="mt-2 text-[11px] text-red-500 font-medium">
                                                                                            {{ __('messages.t_subject_seller_refund_closed') }} <br>
                                                                                        </p>
                                                                                    @elseif ($item->order->invoice && $item->order->invoice->status === 'closed')
                                                                                        <p class="mt-2 text-[11px] text-amber-500 font-medium">
                                                                                            {{ __('messages.t_subject_seller_refund_closed') }} <br>
                                                                                        </p>                                                                                        
                                                                                    ...
                                                                                    @else
                                                                                        ...
                                                                                        @switch($item->status)
                                                                                            ...
                                                                                            {{-- Waiting buyer action --}}
                                                                                            @case('waiting')
                                                                                                <p data-tooltip-target="orders-{{ $order->uid }}-item-{{ $item->id }}-status-proceeded" class="mt-2 text-[11px] text-green-500 font-medium cursor-pointer">
                                                                                                    {{ __('messages.t_waiting_buyer_as_buyer') }}
                                                                                                </p>
                                                                                                <div id="orders-{{ $order->uid }}-item-{{ $item->id }}-status-proceeded" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-xs font-medium text-white bg-gray-900 rounded-sm shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                                                                    <!--{{ format_date($item->proceeded_at, config('carbon-formats.F_j,_Y_h_:_i_A')) }}-->
                                                                                            ...
                                                                                            {{-- Refunded --}}
                                                                                            @case('refunded')
                                                                                                <p data-tooltip-target="orders-{{ $order->uid }}-item-{{ $item->id }}-status-refunded" class="mt-2 text-[11px] text-green-500 font-medium cursor-pointer">
                                                                    ...
                                                                    <div class="mt-4 flex space-x-3 md:mt-0">
                                                                        ...
                                                                        {{-- Contact seller --}} 
                                                                        <a href="{{ url('messages/new', $item->owner?->username) }}" target="_blank" 
                                                                        ...
                                                                        @if ($item->refund)
                                                                            ...
                                                                            <a href="{{ url('account/refunds/details', $item->refund->uid) }}" target="_blank" 
                                                                            class="finline-flex justify-center px-2 py-2 border border-gray-200 dark:border-zinc-700 shadow-sm text-xs font-medium rounded-full text-gray-700 
                                                                            dark:text-gray-300 bg-white dark:bg-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-900 focus:outline-none focus:ring-0">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1"> 
                                                                        ...
                                                                        @else
                                                                            ...
                                                                            @if ($can_refund)
                                                                                ...
                                                                                <a href="{{ url('account/refunds/request', $item->uid) }}" target="_blank" 
                                                                                class="finline-flex justify-center px-2 py-2 border border-gray-200 dark:border-zinc-700 shadow-sm text-xs font-medium rounded-full text-gray-700 
                                                                                dark:text-gray-300 bg-white dark:bg-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-900 focus:outline-none focus:ring-0">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1"> 
                                                                                    <path d="M16 12h2v4h-2z"></path><path d="M20 7V5c0-1.103-.897-2-2-2H5C3.346 3 2 4.346 2 6v12c0 2.201 1.794 3 3 3h15c1.103 0 2-.897 2-2V9c0-1.103-.897-2-2-2zM5 5h13v2H5a1.001 1.001 0 0 1 0-2zm15 14H5.012C4.55 18.988 4 18.805 4 18V8.815c.314.113.647.185 1 .185h15v10z"></path>
                                                                        ...
                                                                        {{-- Delivered work --}}
                                                                        @if ((in_array($item->status, ['proceeded', 'waiting', 'delivered']) AND !$item->refund))
                                                                        ...
                                                                        @if ($item->status === 'pending' && $item->order->invoice && $item->order->invoice->status === 'paid')
                                                                            ...
                                                                            <button type="button" x-on:click="confirm('{{ __('messages.t_are_u_sure_u_want_to_cancel_service') }}') ? $wire.cancel('{{ $item->uid }}') : ''" wire:loading.attr="disabled"
                                                                    ...
                                                                    <div class="inline-block md:!flex text-gray-500 dark:text-gray-300 text-xs space-y-4 md:space-y-0 md:space-x-6 lg:space-x-12 rtl:space-x-reverse">
                                                                        ...
                                                                        <span class="flex">
                                                                            <div class="md:text-center">
                                                                                ...
                                                                                {{-- Refund Pending --}}
                                                                                @if ($item->refund && $item->refund->status === 'rejected_by_admin')
                                                                                    <p class="mt-2 text-[11px] text-red-500 font-medium">
                                                                                        {{ __('messages.t_declined_by_admin') }}
                                                                                    </p>
...
<script>
    document.addEventListener("DOMContentLoaded", function(){
        ...
        ?>
            ...
            window.$wireui.notify({title: '@lang('messages.t_success')', description: '@lang('messages.t_order_has_marked_as_completed')',icon: 'success'});
        <?php
        }
        ?>
    });
