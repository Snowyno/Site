                            ...
                            <div class="mt-5 flex lg:mt-0 lg:ltr:ml-4 lg:rtl:mr-4">
                                    ...
                                    @else
                                        <span class="ltr:ml-3 rtl:mr-3">
                                            <button x-on:click='confirm("{{ __('messages.t_are_sure_completed_work_buyer') }}") ? $wire.completed() : "" ' wire:loading.attr="disabled" wire:target="completed" type="button" name="recebido" class="inline-flex items-center px-4 py-2 border border-transparent rounded-sm shadow-sm text-xs font-bold tracking-wide text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500" disabled>
