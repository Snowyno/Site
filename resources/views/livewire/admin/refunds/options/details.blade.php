                                    ...
                                    <div class="relative {{ !$loop->last ? 'pb-8' : '' }}">
                                        ...
                                        <div class="relative flex items-start space-x-3 rtl:space-x-reverse">
                                            ...
                                            <div class="relative">
                                                ...
                                                src="{{ placeholder_img() }}" 
                                                data-src="{{ $msg->author_type === 'buyer' ? src($msg->buyer->avatar) : src($msg->seller->avatar) }}" 
                                                alt="{{ $msg->author_type === 'buyer' ? $msg->buyer->username : $msg->seller->username }}">
                                            </div>
                                            ...
                                            <div class="min-w-0 flex-1">
                                                <div>
                                                    <div class="text-sm">
                                                        <a href=""
                                                            target="_blank" class="font-medium text-gray-900 hover:text-primary-600">{{ auth()->user()->username }}</a>
                                                    </div>
                                                    <p class="mt-0.5 text-xs text-gray-500">
                                                        {{ format_date($msg->created_at, 'ago') }}
                                                    </p>
