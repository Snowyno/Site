...
Route::middleware(['web', 'auth:admin'])->group(function() {
    ...
    // Cupons
    Route::namespace('Cupons')->prefix('cupons')->group(function() {

        // Cupons
        Route::get('/', CuponsComponent::class);
    ...
    // Chats
    Route::namespace('Chats')->prefix('chats')->group(function() {

        // Chats
        Route::get('/', ChatsComponent::class);

        // Options
        Route::namespace('Options')->group(function() {

            // Details
            Route::get('details/{conversationId}', DetailsComponent::class);
    ...
    // Blackwordslist
    Route::namespace('Blackwordslist')->prefix('blackwordslist')->group(function() {

        // Blackwordslist
        Route::get('/', BlackwordslistComponent::class);
    ...
    // Subcategoriesd
    Route::namespace('Subcategoriesd')->prefix('subcategoriesd')->group(function() {
    
        // All
        Route::get('/', SubcategoriesdComponent::class);
    ...
    Route::namespace('Settings')->prefix('settings')->group(function() {
        ...
        // Timeouts
        Route::get('timeouts', TimeoutsComponent::class);
