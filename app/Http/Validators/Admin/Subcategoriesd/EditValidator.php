...
namespace App\Http\Validators\Admin\Subcategoriesd;
...
class EditValidator
{
    ...
    static function validate($request)
    {
        try {
            ...
            // Set rules
            $rules    = [
                'name'        => ['required', 'max:60', Rule::unique('subcategories')->ignore($request->subcategoryd->id)],
                'slug'        => ['required', 'max:60', Rule::unique('subcategories')->ignore($request->subcategoryd->id)],
