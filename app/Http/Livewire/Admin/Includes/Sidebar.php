...
class Sidebar extends Component
{
    ...
    public function mount()
    {
        ...
        $this->links = [
            ...
            // Cupons
            [
                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M17.707 9.293a1 1 0 010 1.414l-7 7a1 1 0 01-1.414 0l-7-7A.997.997 0 012 10V5a3 3 0 013-3h5c.256 0 .512.098.707.293l7 7zM5 6a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path></svg>',
                'href' => null,
                'text' => __('messages.t_cupons'),
                'childs' => [
                    [ 'text' => __('messages.t_browse_all'), 'href' => "$dashboard/cupons" ],
                    [ 'text' => __('messages.t_create_new'), 'href' => "$dashboard/cupons/create" ],
                ],
            ],
            ...
            [
                ...
                'href' => null,
                'text' => __('messages.t_chats'),
                'childs' => [
                    [ 'text' => __('messages.t_browse_all'), 'href' => "$dashboard/chats" ]
                ],
            ],
            ...
            [
              ...
              ',
                'href' => null,
                'text' => __('messages.t_bwl'),
                'childs' => [
                    [ 'text' => __('messages.t_browse_all'), 'href' => "$dashboard/blackwordslist" ],
                    [ 'text' => __('messages.t_create_new'), 'href' => "$dashboard/blackwordslist/create" ],
                ],
            ],
            ...
            [
                ...
                'childs' => [
                    ...
                    [ 'text' => __('messages.t_subcategories_detail'), 'href' => "$dashboard/subcategoriesd" ]
                ],
            ],
            ...
            [
                ...
                'childs' => [
                    ...
                    [ 'text' => __('messages.t_timeouts'), 'href' => "$dashboard/settings/timeouts" ],
                ],
            ],
