...
namespace App\Http\Livewire\Admin\Chats\Options;
...
class DetailsComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.chats.options.details', [
    ...
    public function send()
    {
        try {
            ...
            foreach($all_blacklistedwords as $blws){
                if (str_contains($message->message, $blws->palvra)) {
                    //$message->message = "<span style='color: red;'>".$message->message."</span>";
                    $clean =false;
            ...
            if(!$clean ){
                ...
                //SEND EMAIL TO ADMIN
                $this->sendEmailtoAdmin($message->msg_from, $word, $message->conversation_id, 'conversation');
