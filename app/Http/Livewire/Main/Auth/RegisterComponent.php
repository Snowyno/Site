...
class RegisterComponent extends Component
{
    ...
    public function register($form)
    {
        try {
            ...
            // Create new user
            //verifica se requere autenticação esta on ou naõ
            if($settings->verification_required != null){
                $user_status_by_verification = 'pending';
            }
            else{
                $user_status_by_verification = 'active';
            }
            ...
            $user->status   =  $user_status_by_verification;
            $user->level_id = 1;
            $user->save();
