...
class DetailsComponent extends Component
{
    ...
    public function render()
    {
        ...
        $select = DB::select('select * from settings_timeouts');
        return view('livewire.main.seller.refunds.options.details')->extends('livewire.main.seller.layout.app')->section('content')->with('settings_timeouts',$select);
    }
