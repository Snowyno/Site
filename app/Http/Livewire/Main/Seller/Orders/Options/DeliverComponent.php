...
class DeliverComponent extends Component
{
    ...
    public function mount($id)
    {
        ...
        // // Order item must be in ['delivered', 'proceeded', 'delivered', 'waiting'] status and not finished yet
        if (!in_array($order->status, ['proceeded', 'delivered', 'waiting'])) {
