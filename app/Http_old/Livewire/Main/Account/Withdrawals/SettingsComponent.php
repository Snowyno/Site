...
use App\Http\Validators\Main\Account\Withdrawals\SettingsValidator;
...
class SettingsComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.main.account.withdrawals.settings')->extends('livewire.main.account.layout.app')->section('content');
    }
