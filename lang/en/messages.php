<?php
    ...
    return [
        "t_confirm_cancellation"                                   => "Order Cancellation Confirm",
        "t_download_info"                                          => "Click buttom to download",
        "t_direct_buy"                                             => "Buy Directly",
        "t_title_games"                                            => "Jogos",
        "t_blockchain_itens"                                       => "Blockchain Itens",
        "t_gift_cards"                                             => "Cartões de Presente",
        "t_game_itens"                                             => "Itens de Jogos",
        "t_popular_categories"                                     => "Categorias Populares",
        "t_agir_ate"                                               => "Agir até",
        ...
        "t_government_issued_id"                                   => "CPF or RG WITH CPF",
        ...
        "t_sold_off"                                               => "Sold Off",
        "t_item_sold_off"                                          => "This item is sold off!",
        ...
        "t_download"                                               => "Download",
        "t_government_issued_id_frontside"                         => "CPF/RG or CPF (front side)",
        "t_government_issued_id_backside"                          => "CPF/RG or CPF (back side)",
        ...
        "t_cupons"                                                 => 'Cupons',
        "t_chats"                                                  => 'Chats',
        "t_bwl"                                                    => 'Black Words List',
        "t_browse_all"                                             => "Browse all",
        "t_all"                                                    => "All",
        "t_show_items_with_status"                                 => 'show items with status',
        "t_create_new"                                             => "Create new",
        "t_categories"                                             => "Categories",
        "t_subcategories"                                          => "Subcategories",
        "t_subcategories_detail"                                   => "Subcategories Details",
        "t_admins"                                                 => "Admins",
        "t_gigs"                                                   => "Gigs",
        ...
        "t_timeouts"                                               => 'Timeouts',
        "t_configure_timeouts"                                     => 'Timeouts Configuration',
        "t_configure_timeouts_subtitle"                            => 'Input the timeout for each action (In minutes)',
        "t_timeout_venda"                                          => 'Item Delivered Timeout (Buyer)    (mininal: 5 minutes)',
        "t_timeout_entrega"                                        => 'Dispute Timeout (Seller) (mininal: 5 minutes)',
        "t_timeout_resposta"                                       => 'Dispute Timeout (Buyer) (mininal: 5 minutes)',
        "t_timeout_info"                                           => 'Act in (Min: 5 minutes)',
        ...
        "t_amount"                                                 => "Amount:",
        "t_amount_lucro"                                           => "Amount to receive:",
        "t_quantity"                                               => "Quantity",
        ...
        "t_waiting_buyer"                                          => "Waiting Buyer",
        "t_in_the_waiting"                                         => 'Order Ended',
        "t_waiting_buyer_as_buyer"                                 => "Waiting your action",
        "t_canceled"                                               => "Canceled",
        "t_refunded"                                               => "Refunded",
        "t_actions"                                                => "Actions",
        "t_act_til"                                                => "Act til:",
        ...
        "t_profit"                                                 => "Profit",
        "t_waiting_for_seller"                                     => "Waiting seller send the item",
        "t_waiting_for_seller_as_seller"                           => "Waiting you send the item",
        "t_waiting_for_requirements"                               => "Waiting for requirements",
        "t_order_details"                                          => "Order details",
        "t_chat_details"                                           => "Chat details",
        ...
        "t_only_zip_allowed_max_size"                              => "Only 'rar', 'zip','png, jpeg, jpg, mp4, m4v, ogg' files allowed and maximum size of :size MB",
        ...
        "t_register_slide_text_1"                                  => "Boost your <span class='text-primary-600'>earnings</span> by driving traffic to P2Win",
        "t_register_slide_text_2"                                  => "Find the perfect <span class='text-primary-600'>freelance</span> services for your business",
        "t_register_subtitle"                                      => "What do you need done? Find it on P2Win . Hire the best freelancers for any job, online, Millions of people use P2Win to turn their ideas into reality. Find professionals you can trust by browsing their samples of previous work and reading their profile reviews.",
        ...
        "t_verification_expiry_period"                             => "Verification expiry period (in minutes)",
        "t_verification_expiry_period_after_minutes"               => "Verification link will expire after how many minutes",
        "t_password_reset_expiry_period"                           => "Password reset expiry period (in minutes)",
        ...
        "t_gig_editions_saved"                                     => "Gig edit saved",
        "t_cupon_is_valid"                                         => "Cupon aplied",
        "t_cupon_is_invalid"                                       => "Invalid Cupon",
        "t_cupon_already_used"                                     => "This Cupon was already used",
        "t_cupon_used_by"                                          => "Used by",
        ...
        "t_edit_cupon"                                             => "Edit Cupon",
        "t_edit_bwl"                                               => "Edit Black listed word",
        "t_delete_page"                                            => "Delete page",
        "t_delete_cupon"                                           => "Delete Cupon",
        "t_delete_bwl"                                             => "Delete Black listed word",
        "t_slug"                                                   => "Slug",
        "t_cupon_cod"                                              => "Cupon code",
        "t_enter_title"                                            => "Enter title",
        "t_enter_slug"                                             => "Enter slug",
        "t_enter_cupon_cod"                                        => "Enter the Coupon Code, only letters and numbers, no spaces or characters. specials",
        "t_enter_page_content"                                     => "Enter page content",
        "t_content"                                                => "Content",
        "t_external_link"                                          => "External link",
        "t_cupon_is_percentage"                                    => "The value is in percentage (%)",
        "t_enter_external_link"                                    => "Enter external link",
        "t_link"                                                   => "Link",
        "t_cupon_value"                                            => "Enter the discount value of the coupon",
        "t_create_page"                                            => "Create page",
        "t_create_cupon"                                           => "Create Cupon",
        "t_create_bwl"                                             => "Insert new word to Blacklist",
        ...
        "t_last_message_at"                                        => "Last Message At",
        ...
        "t_are_u_sure_raise_dispute_refund"                        => "Are you sure you want to raise a dispute to have P2Win investigate this refund request",
        "t_in_progress"                                            => "In progress",
        "t_declined_by_seller"                                     => "Declined by seller",
        "t_declined_by_seller_site_dispute"                        => "Dispute with site",
        "t_declined_by_admin"                                      => "Declined by P2Win",
        "t_approved_by_seller"                                     => "Approved by seller",
        "t_approved_by_admin"                                      => "Approved by P2Win",
        "t_closed"                                                 => "Closed",
        ...
        "t_redund_requested"                                       => "Refund requested",
        ...
        "t_seller_has_declined_ur_refund"                          => "Refund declined by seller",
        ...
        "t_app_name_has_approved_ur_refund_request"                => "P2Win has accepted your refund request",
        "t_app_name_has_approved_refund_request_from_buyer"        => "P2Win has accepted refund request from :username",
        "t_app_name_has_declined_ur_refund_request"                => "P2Win has declined your refund request",
        ...
        "t_latest_appname_news"                                    => "All the latest P2Win news, straight from the team.",
...
"t_chat_with_buyer"                                        => "chat whith buyer",
...
"t_subcategory_detail"                                     => "Subcategories Detail",
"t_edit_subcategory_detail"                                => "Edit",
"t_delete_subcategory_detail"                              => "Delete",
"t_create_subcategory_detail"                              => "Create a subcategory Detail",
"t_subcategory_detail_name"                                => "Subcategory Detail Name",
"t_subcategory_detail_slug"                                => "Subcategory Detail Slug",
"t_parent_subcategory"                                     => "Parent Subcategory",
"t_subcategory_detail_icon"                                => "Subcategory Detail Icon",
"t_subcategory_detail_image"                               => "Subcategory Detail Image",

"t_enter_subcategory_detail_name"                          => "Enter the Subcategory Detail Name",
"t_enter_subcategory_detail_slug"                          => "Enter the Subcategory Detail Slug",
"t_choose_subcategory_detail"                              => "Choose subcategory detail",
"t_choose_parent_subcategory"                              => "Select the Parent Subcategory",
"t_subcategoriesd"                                         => "Subcategories Detail",
"t_account_not_verified_yet"                              => "You need to access your email and verify your account by clicking in the link sended",


"t_Sell"                              => "Sell",

"t_Become_a_Seller"                              => "Become a Seller",
"t_Sell_Game_Items"                              => "Sell Game Items",
"t_Sell_Video_Games"                              => "Sell Video Games",
"t_Sell_Gift_Cards"                              => "Sell Gift Cards",

"t_Buy"                              => "Buy",

"t_How_to_Buy"                              => "How to Buy",
"t_Buy_Game_Items"                              => "Buy Game Items",
"t_Buy_Video_Games"                              => "Buy Video Games",
"t_Buy_Gift_Cards"                              => "Buy Gift Cards",

"t_FAQ"                              => "FAQ",

"t_How_Does_P2_Win_Work"                              => "How Does P2 Win Work?",
"t_What_is_the_P2_Win_Guarantee"                              => "What is the P2 Win Guarantee?",
"t_How_does_P2_Win_protect_sellers"                              => "How does P2 Win protect sellers?",
